...
aliases:
  - The Undead
created: 2026-01-27T14:36:20.491+11:00
modified: 2026-01-27T15:31:08.886+11:00
tags:
...
_[Warlock](./warlock.md): Otherworldly Patron_\
_Source: Van Richten's Guide to Ravenloft p. 30_
...
| 2nd | [blindness/deafness](compendium/spells/blindness-deafness.md), [phantasmal force](compendium/spells/phantasmal-force.md) |
| 3rd | [phantom steed](compendium/spells/phantom-steed.md), [speak with dead](compendium/spells/speak-with-dead.md) |
| 4th | [death ward](compendium/spells/death-ward.md), [greater invisibility](compendium/spells/greater-invisibility.md) |
| 5th | [antilife shell](compendium/spells/antilife-shell.md), [cloudkill](compendium/spells/cloudkill.md) |
^undead-expanded-spells
...
- You gain temporary hit points equal to `dice:1d10|noform|noparens|avg` (`1d10`) + your warlock level.
- Once during each of your turns, when you hit a creature with an attack roll, you can force it to make a Wisdom saving throw, and if the saving throw fails, the target is [frightened](rules/conditions.md#Frightened) of you until the end of your next turn.
...
In addition, when you would be reduced to 0 hit points, you can use your reaction to drop to 1 hit point instead and cause your body to erupt with deathly energy. Each creature of your choice that is within 30 feet of you takes necrotic damage equal to `dice:2d10|noform|noparens|avg` (`2d10`) + your warlock level. You then gain 1 level of [exhaustion](rules/conditions.md#Exhaustion). Once you use this reaction, you can't do so again until you finish `dice:1d4|noform|noparens|avg` (`1d4`) long rests.

### Spirit Projection (Level 14)

_14th-level Undead feature_

Your spirit can become untethered from your physical form. As an action, you can project your spirit from your body. The body you leave behind is [unconscious](rules/conditions.md#Unconscious) and in a state of suspended animation.

Your spirit resembles your mortal form in almost every way, replicating your game statistics but not your possessions. Any damage or other effects that apply to your spirit or physical body affects the other. Your spirit can remain outside your body for up to 1 hour or until your [concentration](rules/conditions.md#Concentration) is broken (as if [concentrating](rules/conditions.md#Concentration) on a spell). When your projection ends, your spirit returns to your body or your body magically teleports to your spirit's space (your choice).
...
- You have a flying speed equal to your walking speed and can hover. You can move through creatures and objects as if they were difficult terrain, but you take `dice:1d10|noform|noparens|avg` (`1d10`) force damage if you end your turn inside a creature or an object.
