...
aliases:
  - Artificer
created: 2026-01-27T14:36:20.452+11:00
modified: 2026-01-27T15:31:07.874+11:00
tags:
  - class/artificer
...
_Source: Tasha's Cauldron of Everything p. 9, Eberron: Rising from the Last War p. 54_
...
> <li>‡1: Optional features from <a href="compendium/lists/list-optfeaturetype-ai.md">Artificer Infusion</a>; defined in Tasha's Cauldron of Everything</li>
> </ul></section>
...
- **Skills**: choose 2 from [Arcana](rules/skills.md#Arcana), [History](rules/skills.md#History), [Investigation](rules/skills.md#Investigation), [Medicine](rules/skills.md#Medicine), [Nature](rules/skills.md#Nature), [Perception](rules/skills.md#Perception), and [Sleight of Hand](rules/skills.md#Sleight%20of%20Hand)
...
When you gain this feature, pick four artificer infusions to learn, choosing from the "Artificer Infusions^\[Optional features from [Artificer Infusion](compendium/lists/list-optfeaturetype-ai.md); defined in Tasha's Cauldron of Everything]" section at the end of the class's description. You learn additional infusions of your choice when you reach certain levels in this class, as shown in the Infusions Known column of the Artificer table.
...
If an infusion ends on an item that contains other things, like a [bag of holding](compendium/items/bag-of-holding.md), its contents harmlessly appear in and around its space.
...
_12th-level artificer feature_
...
_15th-level artificer feature_

You gain a feature granted by your Artificer Specialist choice.

### Ability Score Improvement (Level 16)

_16th-level artificer feature_
...
_19th-level artificer feature_
...
> ![Artificer Infusion](compendium/lists/list-optfeaturetype-ai.md#Artificer%20Infusion)
> ^list-optfeature-ai
