...
aliases:
  - The Fiend
created: 2026-01-27T14:36:20.596+11:00
modified: 2026-01-27T15:31:09.112+11:00
tags:
...
_Source: Player's Handbook p. 109. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>_
...
> </thead><tbody>
> <tr class="class-progression"><td class"level">1st</td><td class"pb">+2</td><td class"feature"><a href='#The Fiend (Level 1)' class='internal-link'>The Fiend</a></td></tr>
...
Starting at 6th level, you can call on your patron to alter fate in your favor. When you make an ability check or a saving throw, you can use this feature to add a `dice:d10|noform|noparens|avg` (`d10`) to your roll. You can do so after seeing the initial roll but before any of the roll's effects occur.
...
At the end of your next turn, the target returns to the space it previously occupied, or the nearest unoccupied space. If the target is not a fiend, it takes `dice:10d10|noform|noparens|avg` (`10d10`) psychic damage as it reels from its horrific experience.
