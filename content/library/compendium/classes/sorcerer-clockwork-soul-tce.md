...
aliases:
  - Clockwork Soul
created: 2026-01-27T14:36:20.465+11:00
modified: 2026-01-27T15:31:08.854+11:00
tags:
...
_Source: Tasha's Cauldron of Everything p. 68_
...
> </thead><tbody>
> <tr class="class-progression"><td class"level">1st</td><td class"pb">+2</td><td class"feature"><a href='#Clockwork Soul (Level 1)' class='internal-link'>Clockwork Soul</a></td></tr>
...
Your connection to the plane of absolute order allows you to equalize chaotic moments. When a creature you can see within 60 feet of you is about to roll a `dice:d20|noform|noparens|avg` (`d20`) with advantage or disadvantage, you can use your reaction to prevent the roll from being affected by advantage and disadvantage.
...
The ward is represented by a number of `dice:d8|noform|noparens|avg` (`d8`)s equal to the number of sorcery points spent to create it. When the warded creature takes damage, it can expend a number of those dice, roll them, and reduce the damage taken by the total rolled on those dice.

### Trance of Order (Level 14)

_14th-level Clockwork Soul feature_

You gain the ability to align your consciousness to the endless calculations of Mechanus. As a bonus action, you can enter this state for 1 minute. For the duration, attack rolls against you can't benefit from advantage, and whenever you make an attack roll, an ability check, or a saving throw, you can treat a roll of 9 or lower on the `dice:d20|noform|noparens|avg` (`d20`) as a 10.
