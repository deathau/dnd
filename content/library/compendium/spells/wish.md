...
**Classes**: [Bard (Magical Secrets)](compendium/lists/list-spells-classes-bard.md); [Cleric (Arcana Domain)](compendium/lists/list-spells-classes-arcana-domain-scag.md "subclass=SCAG"); [Sorcerer](compendium/lists/list-spells-classes-sorcerer.md); [Warlock (The Genie, Dao)](compendium/lists/list-spells-classes-the-genie-tce.md "subclass=TCE"); [Wizard](compendium/lists/list-spells-classes-wizard.md)

_Source: Player's Handbook p. 288. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>_
