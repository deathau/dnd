...
**Classes**: [Bard (Magical Secrets)](compendium/lists/list-spells-classes-bard.md); [Cleric (Trickery Domain)](compendium/lists/list-spells-classes-trickery-domain.md); [Wizard](compendium/lists/list-spells-classes-wizard.md)

_Source: Player's Handbook p. 261. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>_
