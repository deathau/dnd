...
modified: 2026-01-27T15:31:10.064+11:00
tags:
...
| 3 | Magic (`dice:d6\|noform\|noparens\|avg\|text(d6)` (`d6`)) |  |
...
| 4 | Mayhem (`dice:d6\|noform\|noparens\|avg\|text(d6)` (`d6`)) |  |
...
| 5 | Passion (`dice:d4\|noform\|noparens\|avg` (`d4`)) |  |
...
| 6 | Power (`dice:d4\|noform\|noparens\|avg\|text(d4)` (`d4`)) |  |
...
| 7 | Revenge (`dice:d4\|noform\|noparens\|avg` (`d4`)) |  |
...
| 8 | Wealth (`dice:d4\|noform\|noparens\|avg\|text(d4)` (`d4`)) |  |
