...
| 11 | A romantic relationship ended. Roll a `dice:d6\|noform\|noparens\|avg` (`d6`). An odd number means it ended with bad feelings, while an even number means it ended amicably. |
| 12 | A current or prospective romantic partner of yours died. Roll on the Cause of Death supplemental table to find out how. If the result is murder, roll a `dice:d12\|noform\|noparens\|avg` (`d12`). On a 1, you were responsible, whether directly or indirectly. |
^tragedies
