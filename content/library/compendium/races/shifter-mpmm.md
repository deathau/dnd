...
aliases:
  - Shifter
created: 2026-01-27T14:36:20.525+11:00
modified: 2026-01-27T15:31:08.979+11:00
tags:
...
_Source: Mordenkainen Presents: Monsters of the Multiverse p. 32_
...
Channeling the beast within, you have proficiency in one of the following skills of your choice: [Acrobatics](rules/skills.md#Acrobatics), [Athletics](rules/skills.md#Athletics), [Intimidation](rules/skills.md#Intimidation), or [Survival](rules/skills.md#Survival).
...
- **Beasthide.** You gain `dice:1d6|noform|noparens|avg` (`1d6`) additional temporary hit points. While shifted, you have a +1 bonus to your Armor Class.
- **Longtooth.** When you shift and as a bonus action on your other turns while shifted, you can use your elongated fangs to make an unarmed strike. If you hit with your fangs, you can deal piercing damage equal to `dice:1d6|noform|noparens|avg` (`1d6`) + your Strength modifier, instead of the bludgeoning damage normal for an unarmed strike.
...
- **Wildhunt.** While shifted, you have advantage on Wisdom checks, and no creature within 30 feet of you can make an attack roll with advantage against you unless you're [incapacitated](rules/conditions.md#Incapacitated).
