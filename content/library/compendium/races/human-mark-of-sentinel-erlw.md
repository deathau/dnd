...
modified: 2026-01-27T15:31:07.746+11:00
tags:
...
_Source: Eberron: Rising from the Last War p. 48_
...
When you make a Wisdom ([Insight](rules/skills.md#Insight)) or Wisdom ([Perception](rules/skills.md#Perception)) check, you can roll a `dice:d4|noform|noparens|avg` (`d4`) and add the number rolled to the ability check.
