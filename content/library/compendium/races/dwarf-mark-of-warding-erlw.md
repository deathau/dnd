...
created: 2026-01-27T14:36:20.516+11:00
modified: 2026-01-27T15:31:08.462+11:00
tags:
...
_Source: Eberron: Rising from the Last War p. 51_
...
When you make an Intelligence ([Investigation](rules/skills.md#Investigation)) check or an ability check using [thieves' tools](compendium/items/thieves-tools.md), you can roll a `dice:d4|noform|noparens|avg` (`d4`) and add the number rolled to the ability check.
