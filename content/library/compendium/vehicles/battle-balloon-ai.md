...
aliases:
  - Battle Balloon
created: 2026-01-27T14:36:20.437+11:00
modified: 2026-01-27T16:12:04.682+11:00
tags:
...
_Source: Acquisitions Incorporated p. 218_

_Through the winter clouds that surround the castle on this desolate hill, you see a shape emerge. Something so gigantic, you can't believe it can actually fly._
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/vehicles/tokens/AI/Battle%20Balloon.webp#token)
...
*Ranged Weapon Attack:* `dice:1d20+8|noform|noparens|text(+8)` to hit, range 200/800 ft. (can't hit targets within 60 ft. of it) one target. *Hit:* `dice:3d10|noform|noparens|avg|text(16)` (`3d10`) piercing damage and `dice:4d10|noform|noparens|avg|text(22)` (`4d10`) fire damage. If the attack misses, the DM determines where the arbalester bolt hits. Each creature within 10 feet of that spot must make a DC 15 Dexterity saving throw to avoid the bolt as it shatters, taking `dice:1d10|noform|noparens|avg|text(5)` (`1d10`) piercing damage and `dice:1d10|noform|noparens|avg|text(5)` (`1d10`) fire damage on a failed save.
