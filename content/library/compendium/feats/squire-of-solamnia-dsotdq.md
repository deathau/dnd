...
aliases:
  - Squire of Solamnia
created: 2026-01-27T14:36:20.454+11:00
modified: 2026-01-27T15:31:08.818+11:00
tags:
...
_Source: Dragonlance: Shadow of the Dragon Queen p. 34_

**Prerequisite**:  Fighter, Dragonlance Campaign,  Paladin, Dragonlance Campaign, or [Knight of Solamnia](compendium/backgrounds/knight-of-solamnia-dsotdq.md), Dragonlance Campaign
...
- **Precise Strike.** Once per turn, when you make a weapon attack roll against a creature, you can cause the attack roll to have advantage. If the attack hits, you roll a `dice:d8|noform|noparens|avg` (`d8`) and add the number rolled as a bonus to the attack's damage roll. You can use this benefit a number of times equal to your proficiency bonus, but a use is expended only if the attack hits. You regain all expended uses when you finish a long rest.
