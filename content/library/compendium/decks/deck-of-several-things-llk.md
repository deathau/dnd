...
created: 2026-01-27T14:36:20.464+11:00
modified: 2026-01-27T15:31:07.894+11:00
tags:
...
_Source: Lost Laboratory of Kwalish p. 53_
...
Once a card is drawn, it fades from existence. Unless the card is the [Fool](compendium/decks/deck-of-several-things-llk.md#Fool) or the [Jester](compendium/decks/deck-of-several-things-llk.md#Jester), the card reappears in the deck, making it possible to draw the same card twice.

`dice: [](deck-of-several-things-llk.md#^1-playing-card-card)`

| dice: 1d22 | Playing Card | Card |
|------------|--------------|------|
| 1 | Ace of diamonds | [Vizier](compendium/decks/deck-of-several-things-llk.md#Vizier) |
| 2 | King of diamonds | [Sun](compendium/decks/deck-of-several-things-llk.md#Sun) |
| 3 | Queen of diamonds | [Moon](compendium/decks/deck-of-several-things-llk.md#Moon) |
| 4 | Jack of diamonds | [Star](compendium/decks/deck-of-several-things-llk.md#Star) |
| 5 | Two of diamonds | [Comet](compendium/decks/deck-of-several-things-llk.md#Comet) |
| 6 | Ace of hearts | [The Fates](compendium/decks/deck-of-several-things-llk.md#The%20Fates) |
| 7 | King of hearts | [Throne](compendium/decks/deck-of-several-things-llk.md#Throne) |
| 8 | Queen of hearts | [Key](compendium/decks/deck-of-several-things-llk.md#Key) |
| 9 | Jack of hearts | [Knight](compendium/decks/deck-of-several-things-llk.md#Knight) |
| 10 | Two of hearts | [Gem](compendium/decks/deck-of-several-things-llk.md#Gem) |
| 11 | Ace of clubs | [Talons](compendium/decks/deck-of-several-things-llk.md#Talons) |
| 12 | King of clubs | [The Void](compendium/decks/deck-of-several-things-llk.md#The%20Void) |
| 13 | Queen of clubs | [Flames](compendium/decks/deck-of-several-things-llk.md#Flames) |
| 14 | Jack of clubs | [Skull](compendium/decks/deck-of-several-things-llk.md#Skull) |
| 15 | Two of clubs | [Idiot](compendium/decks/deck-of-several-things-llk.md#Idiot) |
| 16 | Ace of spades | [Donjon](compendium/decks/deck-of-several-things-llk.md#Donjon) |
| 17 | King of spades | [Ruin](compendium/decks/deck-of-several-things-llk.md#Ruin) |
| 18 | Queen of spades | [Euryale](compendium/decks/deck-of-several-things-llk.md#Euryale) |
| 19 | Jack of spades | [Rogue](compendium/decks/deck-of-several-things-llk.md#Rogue) |
| 20 | Two of spades | [Balance](compendium/decks/deck-of-several-things-llk.md#Balance) |
| 21 | Joker (with TM) | [Fool](compendium/decks/deck-of-several-things-llk.md#Fool) |
| 22 | Joker (without TM) | [Jester](compendium/decks/deck-of-several-things-llk.md#Jester) |
^1-playing-card-card

> [!note] Using the Deck of Several Things
>
> The special nature of this deck (carried by [Mary Greymalkin](compendium/bestiary/npc/mary-greymalkin-llk.md) if she is used as an NPC) means that many of its effects operate only within and with respect to this specific adventure. This typically covers any time the characters spend between setting out for the Barrier Peaks and the resolution of whatever events transpire in Kwalish's lab (area O7).
>
> For cards that effectively remove a character from play for a period of time ([Donjon](compendium/decks/deck-of-several-things-llk.md#Donjon) and [the Void](compendium/decks/deck-of-several-things-llk.md#The%20Void)), you can allow a player to take on the role of one of the party's NPC hirelings, or introduce a temporary character as an NPC met during the party's journey. Alternatively, you can decide that only some aspect of the character's will disappears and is imprisoned, leaving the character to operate in a robotic state until freed.
...
The Grand Master of the Monastery of the Distressed Body becomes your enemy. The bone devil seeks your ruin, savoring your suffering before attempting to slay you. If the Grand Master has already been defeated, you gain the enmity of [Garret Levistusson's](compendium/bestiary/npc/garret-levistusson-llk.md) patron—a similarly powerful devil.
...
The 1,000 gp hoard of the leprechaun from the [Wilderness Encounters](compendium/tables/wilderness-encounters-llk.md) table (see appendix A) appears at your feet. If that treasure has already been claimed, you gain an equivalent hoard.

### Idiot

Reduce your Intelligence by `dice:1d4+1|noform|noparens|avg` (`1d4 + 1`) (to a minimum score of 1) for the duration of the adventure. You can draw one additional card beyond your declared draws.
...
A common or uncommon magic weapon with which you are proficient, or a [spell scroll](compendium/items/spell-scroll.md) featuring a spell of a level you can cast, appears in your hands. The DM chooses the weapon or spell, which you possess for the duration of this adventure.
...
You are granted the ability to cast any spell of 5th level or lower, and can use that ability `dice:1d3|noform|noparens|avg` (`1d3`) times for the duration of the adventure.
