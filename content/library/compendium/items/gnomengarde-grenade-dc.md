...
aliases:
  - Gnomengarde Grenade
created: 2026-01-27T14:36:20.384+11:00
modified: 2026-01-27T15:31:07.765+11:00
tags:
...
- Each creature must make a DC 15 Dexterity saving throw, taking `dice:8d6|noform|noparens|avg|text(28)` (`8d6`) fire damage on a failed save, or half as much fire damage on a successful one.
- Each creature must make a DC 15 Constitution saving throw. On a failed save, it takes `dice:8d6|noform|noparens|avg|text(28)` (`8d6`) thunder damage and is [stunned](rules/conditions.md#Stunned) until the end of its next turn. On a successful save, it takes half as much thunder damage and is not [stunned](rules/conditions.md#Stunned).
- The wielder rolls on the chart\* for the [wand of wonder](compendium/items/wand-of-wonder.md) three times, rerolling any duplicate results. Any effects that specify a target affect all creatures in range of the grenade when it explodes. Any effects that would affect the wielder of the wand instead affect the closest creature to the grenade when it goes off.
