...
aliases:
  - Azuredge
created: 2026-01-27T14:36:20.434+11:00
modified: 2026-01-27T15:31:07.833+11:00
tags:
...
_Weapon ([battleaxe](compendium/items/battleaxe.md)), legendary (requires attunement)_
...
Forged by the archwizard Ahghairon, this intelligent battleaxe was crafted to defend Waterdeep. Its current wielder is a former member of Force Grey named [Meloon Wardragon](compendium/bestiary/npc/meloon-wardragon-wdh.md), but the weapon is searching for a new owner.
...
You gain a +3 bonus to attack and damage rolls made with this magic weapon. The [shield](compendium/spells/shield.md) spell provides no defense against the axe, which passes through that spell's barrier of magical force.
...
Azuredge is a sentient lawful neutral weapon with an Intelligence of 12, a Wisdom of 15, and a Charisma of 15. It has hearing and [darkvision](rules/senses.md#Darkvision) out to a range of 120 feet.
...
If someone tries to use Azuredge against its will, the axe can become ten times heavier than normal, and can magically adhere to any Medium or larger object or surface it comes into contact with. Once it does so, the axe can't be wielded. Nothing short of a [wish](compendium/spells/wish.md) spell can separate the axe from the item or surface to which it is adhered without destroying one or the other, though the axe can choose to end the effect at any time.

_Source: Waterdeep: Dragon Heist p. 189_
