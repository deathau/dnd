...
aliases:
  - Prismari Primer
created: 2026-01-27T14:36:20.607+11:00
modified: 2026-01-27T15:31:08.622+11:00
tags:
...
The Prismari Primer is a magic textbook created at Strixhaven's Prismari College. The primer has 3 charges, and it regains `dice:1d3|noform|noparens|avg` (`1d3`) expended charges daily at dawn. If you make a Dexterity ([Acrobatics](rules/skills.md#Acrobatics)) or a Charisma ([Performance](rules/skills.md#Performance)) check while holding the primer, you can expend 1 charge to give yourself a `dice:1d4|noform|noparens|avg` (`1d4`) bonus to the check, immediately after you roll the `dice:d20|noform|noparens|avg` (`d20`).
...
_Source: Strixhaven: A Curriculum of Chaos p. 39_
