...
_Wondrous item, legendary (requires attunement by a bard, sorcerer, or warlock)_
...
- **Topsy-Turvy.** When you roll a 1 on a `dice:d20|noform|noparens|avg` (`d20`), you can treat the roll as if you rolled a 20 instead. Once this property is used, it can't be used again until the next dawn.

_Source: The Book of Many Things p. 36_
