...
modified: 2026-01-27T15:31:08.396+11:00
tags:
...
_Weapon ([longsword](compendium/items/longsword.md)), legendary (requires attunement by a creature of non-evil alignment)_
...
While holding the weapon, you can use an action to touch a creature with the blade and cast [lesser restoration](compendium/spells/lesser-restoration.md) on that creature. Once used, this ability can't be used again until the next dawn.

## Sentience

Dawnbringer is a sentient neutral good weapon with an Intelligence of 12, a Wisdom of 15, and a Charisma of 14. It has hearing and [darkvision](rules/senses.md#Darkvision) out to a range of 120 feet.
...
_Source: Out of the Abyss p. 222_
