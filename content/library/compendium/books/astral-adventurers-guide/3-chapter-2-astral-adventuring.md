...
created: 2026-02-03T15:06:54.119+11:00
modified: 2026-02-03T15:06:54.119+11:00
tags:
...
_Source: Astral Adventurer's Guide, p. 17_
...
Spelljamming is the act of using a [spelljamming helm](compendium/items/spelljamming-helm-aag.md) ("described later" in the chapter) to propel and maneuver a ship. The individual that operates the helm is called a spelljammer.

### Speed

When cruising through space, a spelljamming ship can travel 100 million miles in 24 hours. At this speed, the [spelljamming helm](compendium/items/spelljamming-helm-aag.md) makes minor course corrections on its own to avoid collisions with meteorites, other detritus, and space-dwelling creatures. These slight course corrections sometimes cause mild space sickness, which is a harmless affliction common among those who aren't accustomed to space travel.

A spelljamming ship automatically slows to its flying speed (discussed later in this chapter) when it comes within 1 mile of something weighing 1 ton or more, such as another ship, a [kindori](compendium/bestiary/celestial/kindori-bam.md) (see "Boo's Astral Menagerie"), an asteroid, or a planet. While moving at its flying speed, a spelljamming ship is generally as maneuverable as a seafaring vessel of a similar size. A spelljamming ship moving at its flying speed can accelerate to its 100-million-miles-every-24-hours speed provided there is nothing weighing 1 ton or more within 1 mile of the ship.

### Sensations

Using a [spelljamming helm](compendium/items/spelljamming-helm-aag.md) to move a ship produces a feeling in the spelljammer similar to moving a limb that has fallen asleep—a pins-and-needles sensation, though not as painful as its analog. When the ship approaches something large in space, the spelljammer is usually the first to detect it as the ship slows down. An experienced spelljammer can often sense what caused the ship to slow down a few moments before it can be seen; an asteroid "feels" different from a space galleon or a pod of [kindori](compendium/bestiary/celestial/kindori-bam.md), for example.

### Spelljammer Duels

A ship can have more than one [spelljamming helm](compendium/items/spelljamming-helm-aag.md) aboard it, but only one [spelljamming helm](compendium/items/spelljamming-helm-aag.md) at a time can be used to control the ship. If a spelljammer tries to gain control of a ship by using a second [spelljamming helm](compendium/items/spelljamming-helm-aag.md), a spelljammer duel ensues. Resolve this conflict by having each spelljammer make a Constitution check; if the dueling spelljammers tie, have them reroll. The spelljammer with the lowest check result loses the duel and gains `dice:1d4|noform|noparens|avg` (`1d4`) levels of [exhaustion](rules/conditions.md#Exhaustion); in addition, their attunement to their [spelljamming helm](compendium/items/spelljamming-helm-aag.md) ends at once, and they can't attune to any [spelljamming helm](compendium/items/spelljamming-helm-aag.md) until all levels of [exhaustion](rules/conditions.md#Exhaustion) are removed from them.
...
![Air Envelopes of Creatures](compendium/tables/air-envelopes-of-creatures-aag.md)
...
The air envelope around a spelljamming ship typically has an ovoid shape. "Diagram 2.1" shows the air envelope that surrounds a [nautiloid](compendium/vehicles/nautiloid-aag.md) that has a keel length of 180 feet. It extends 180 feet from the ship in all directions.
...
>
> Although nonmagical fire cannot exist in the vacuum of Wildspace, magical fire (such as that created by a [fireball](compendium/spells/fireball.md) spell) does burn in a vacuum. Magical fire does not cause objects to burst into flame, however, because there is no air to make ignition possible.
> ^fire-in-wildspace
...
**Foul air** is stale and partially depleted. It is humid and smells bad. Any creature that breathes foul air becomes [poisoned](rules/conditions.md#Poisoned) until it breathes fresh air again. The air aboard a ship with a normal crew complement degrades from fresh to foul on day 121, and the foul air turns deadly 120 days later.
...
Wildspace is where the Astral Plane overlaps with the Material Plane. Creatures and objects in Wildspace age normally and exist on both planes simultaneously. This overlap enables creatures to use spells such as [teleport](compendium/spells/teleport.md) and [teleportation circle](compendium/spells/teleportation-circle.md) to travel from Wildspace to a nearby world, or vice versa.
...
World-to-world travel requires a spelljamming ship, a [teleport](compendium/spells/teleport.md) spell, or some other kind of magic.
...
Fishing is a popular pastime in Wildspace and the Astral Sea, though this activity isn't possible aboard a ship that is moving faster than its flying speed (discussed later in this chapter). Wildspace settlements sell [basic fishing equipment](compendium/items/basic-fishing-equipment-aag.md) for 1 sp. For that, you get a pole, a line, a hook, and either a lure or some bait.

At the end of each hour spent fishing, a character can make a DC 15 Wisdom ([Survival](rules/skills.md#Survival)) check. A failed check indicates no fish is caught during that hour. On a successful check, roll a `dice:d10|noform|noparens|avg` (`d10`) and consult the Fishing table to determine the catch.

![Astral Fishing; Fishing](compendium/tables/astral-fishing-fishing-aag.md)
...
The Spells table shows which classes can cast the spells in this section and the levels of those spells. The table also notes the school of magic of a spell and which classes have access to it. (The [artificer class](compendium/classes/artificer-tce.md) is presented in "Tasha's Cauldron of Everything".)

![Spells](compendium/tables/spells-aag.md)
...
- [Fish Suit](compendium/items/fish-suit-aag.md)
- [Spelljamming Helm](compendium/items/spelljamming-helm-aag.md)
- [Wildspace Orrery](compendium/items/wildspace-orrery-aag.md)
...
- [Crew](rules/variant-rules/crew-aag.md)
- [Ship-to-Ship Combat](rules/variant-rules/ship-to-ship-combat-aag.md)
- [Crashing](rules/variant-rules/crashing-aag.md)
- [Ship Repairs](rules/variant-rules/ship-repairs-aag.md)

## Spelljammer Vessels

- [Bombard](compendium/vehicles/bombard-aag.md)
- [Damselfly Ship](compendium/vehicles/damselfly-ship-aag.md)
- [Flying Fish Ship](compendium/vehicles/flying-fish-ship-aag.md)
- [Hammerhead Ship](compendium/vehicles/hammerhead-ship-aag.md)
- [Lamprey Ship](compendium/vehicles/lamprey-ship-aag.md)
- [Living Ship](compendium/vehicles/living-ship-aag.md)
- [Nautiloid](compendium/vehicles/nautiloid-aag.md)
- [Nightspider](compendium/vehicles/nightspider-aag.md)
- [Scorpion Ship](compendium/vehicles/scorpion-ship-aag.md)
- [Shrike Ship](compendium/vehicles/shrike-ship-aag.md)
- [Space Galleon](compendium/vehicles/space-galleon-aag.md)
- [Squid Ship](compendium/vehicles/squid-ship-aag.md)
- [Star Moth](compendium/vehicles/star-moth-aag.md)
- [Turtle Ship](compendium/vehicles/turtle-ship-aag.md)
- [Tyrant Ship](compendium/vehicles/tyrant-ship-aag.md)
- [Wasp Ship](compendium/vehicles/wasp-ship-aag.md)
