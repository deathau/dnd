...
modified: 2026-01-27T15:31:09.091+11:00
tags:
  - background
...
_Source: Dragonlance: Shadow of the Dragon Queen p. 30_

_**Prerequisites**_ Dragonlance Campaign

- **Skill Proficiencies.** [Arcana](rules/skills.md#Arcana), [History](rules/skills.md#History)
- **Languages.** Two of your choice
- **Equipment.** A [bottle of colored ink](compendium/items/ink-1-ounce-bottle.md), an [ink pen](compendium/items/ink-pen.md), a set of [common clothes](compendium/items/common-clothes.md), and a [pouch](compendium/items/pouch.md) containing 10 gp
...
You gain the [Initiate of High Sorcery](compendium/feats/initiate-of-high-sorcery-dsotdq.md) feat.
...
When you make your character, roll once on the Mage of High Sorcery Trinkets table instead of on the [Trinkets table](compendium/items/trinket.md) in the Player's Handbook for your starting trinket.
