...
_Source: Van Richten's Guide to Ravenloft p. 35_

- **Skill Proficiencies.** Choose two from among [Insight](rules/skills.md#Insight), [Investigation](rules/skills.md#Investigation), or [Perception](rules/skills.md#Perception)
- **Tool Proficiencies.** [Disguise kit](compendium/items/disguise-kit.md), [Thieves' tools](compendium/items/thieves-tools.md)
- **Equipment.** A [magnifying glass](compendium/items/magnifying-glass.md), evidence from a past case (choose one or roll for a trinket from the [Horror Trinkets](compendium/items/horror-trinket-vrgr.md) later in this chapter), a [set of common clothes](compendium/items/common-clothes.md), and 10 gp
