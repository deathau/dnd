...
modified: 2026-01-27T15:31:08.757+11:00
tags:
  - background
...
_Source: Van Richten's Guide to Ravenloft p. 34_

- **Skill Proficiencies.** Choose two from among [Arcana](rules/skills.md#Arcana), [Investigation](rules/skills.md#Investigation), [Religion](rules/skills.md#Religion), or [Survival](rules/skills.md#Survival)
...
- **Equipment.** [Monster hunter's pack](compendium/items/monster-hunters-pack-vrgr.md) (containing a [chest](compendium/items/chest.md), a [crowbar](compendium/items/crowbar.md), a [hammer](compendium/items/hammer.md), three wooden stakes, a [holy symbol](compendium/items/holy-symbol.md), a [flask of holy water](compendium/items/holy-water-flask.md), a [set of manacles](compendium/items/manacles.md), a [steel mirror](compendium/items/steel-mirror.md), a [flask of oil](compendium/items/oil-flask.md), a [tinderbox](compendium/items/tinderbox.md), and 3 [torches](compendium/items/torch.md)), a set of [common clothes](compendium/items/common-clothes.md), one trinket of special significance (choose one or roll on the [Horror Trinkets](compendium/items/horror-trinket-vrgr.md) table), and 1 sp
