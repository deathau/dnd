...
modified: 2026-01-27T15:31:08.401+11:00
tags:
  - background
...
_Source: Tomb of Annihilation p. 192_

- **Skill Proficiencies.** [History](rules/skills.md#History), [Survival](rules/skills.md#Survival)
- **Tool Proficiencies.** [Cartographer's tools](compendium/items/cartographers-tools.md) or [navigator's tools](compendium/items/navigators-tools.md)
- **Languages.** One of your choice
- **Equipment.** A [wooden case](compendium/items/map-or-scroll-case.md) containing a map to a ruin or dungeon, a [bullseye lantern](compendium/items/bullseye-lantern.md), a [miner's pick](compendium/items/miners-pick.md), a set of [traveler's clothes](compendium/items/travelers-clothes.md), a [shovel](compendium/items/shovel.md), a [two-person tent](compendium/items/two-person-tent.md), a [trinket](compendium/items/trinket.md) recovered from a dig site, and a [pouch](compendium/items/pouch.md) containing 25 gp
...
| dice: d8 | Item |
|----------|------|
| 1 | [10-foot pole](compendium/items/pole-10-foot.md) |
| 2 | [Crowbar](compendium/items/crowbar.md) |
| 3 | Hat |
| 4 | [Hooded lantern](compendium/items/hooded-lantern.md) |
| 5 | Medallion |
| 6 | [Shovel](compendium/items/shovel.md) |
| 7 | [Sledgehammer](compendium/items/sledgehammer.md) |
| 8 | [Whip](compendium/items/whip.md) |
^signature-item
