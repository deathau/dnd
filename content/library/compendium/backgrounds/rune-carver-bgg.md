...
_Source: Bigby Presents: Glory of the Giants p. 12_
...
- **Languages.** Giant
- **Equipment.** A set of artisan's tools (one of your choice), a small knife, a [whetstone](compendium/items/whetstone.md), a set of [common clothes](compendium/items/common-clothes.md), and a [pouch](compendium/items/pouch.md) containing 10 gp
...
You gain the [Rune Shaper](compendium/feats/rune-shaper-bgg.md) feat.
