...
_Source: Storm King's Thunder p. 184_
...
```ad-statblock
title: Duke Zalto
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Duke%20Zalto.webp#token)
...
- **Skills** [Athletics](rules/skills.md#Athletics) +11, [Perception](rules/skills.md#Perception) +6
...
***Special Equipment.*** Zalto wears a [ring of lightning resistance](compendium/items/ring-of-lightning-resistance.md).

***Tackle.*** When Zalto enters any enemy's space for the first time on a turn, the enemy must succeed on a DC 19 Strength saving throw or be knocked [prone](rules/conditions.md#Prone).
