...
aliases:
  - Ghald
created: 2026-01-27T15:31:08.835+11:00
...
- **Skills** [Insight](rules/skills.md#Insight) +4, [Perception](rules/skills.md#Perception) +7
...
***Assassinate.*** During its first turn, Ghald has advantage on attack rolls against any creature that hasn't taken a turn. Any hit Ghald scores against a [surprised](rules/conditions.md#Surprised) creature is a critical hit.
...
***Sneak Attack.*** Ghald deals an extra 14 (4d6) damage when he hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Ghald's that isn't [incapacitated](rules/conditions.md#Incapacitated) and Ghald doesn't have disadvantage on the attack roll.
