...
modified: 2026-01-27T16:05:46.945+11:00
tags:
...
_Source: Baldur's Gate: Descent Into Avernus p. 87_

```ad-statblock
title: Raggadragga
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BGDIA/Raggadragga.webp#token)
...
***Charge (Boar or Hybrid Form Only).*** If Raggadragga moves at least 15 feet straight toward a target and then hits it with its tusks on the same turn, the target takes an extra 7 (2d6) slashing damage. If the target is a creature, it must succeed on a DC 13 Strength saving throw or be knocked [prone](rules/conditions.md#Prone).
