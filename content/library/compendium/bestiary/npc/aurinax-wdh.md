...
aliases:
  - Aurinax
created: 2026-01-27T15:31:08.446+11:00
modified: 2026-01-27T16:12:04.774+11:00
tags:
...
_Source: Waterdeep: Dragon Heist p. 194_

```ad-statblock
title: Aurinax
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Aurinax.webp#token)
...
- **Skills** [Insight](rules/skills.md#Insight) +8, [Perception](rules/skills.md#Perception) +14, [Persuasion](rules/skills.md#Persuasion) +13, [Stealth](rules/skills.md#Stealth) +8
...
Legendary Action Uses: 3. Immediately after another creature's turn, Aurinax can expend a use to take one of the following actions. Aurinax regains all expended uses at the start of each of their turns.

***Detect.*** Aurinax makes a Wisdom ([Perception](rules/skills.md#Perception)) check.

***Tail Attack.*** Aurinax makes a tail attack.

***Wing Attack (Costs 2 Actions).*** Aurinax beats its wings. Each creature within 10 feet of Aurinax must succeed on a DC 22 Dexterity saving throw or take 15 (2d6 + 8) bludgeoning damage and be knocked [prone](rules/conditions.md#Prone). Aurinax can then fly up to half its flying speed.
```
