...
aliases:
  - Brusipha
created: 2026-01-27T15:31:09.157+11:00
modified: 2026-01-27T16:12:05.229+11:00
tags:
...
_Source: The Book of Many Things p. 127_

```ad-statblock
title: Brusipha
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Brusipha.webp#token)
...
- **Skills** [Deception](rules/skills.md#Deception) +5, [Perception](rules/skills.md#Perception) +7, [Religion](rules/skills.md#Religion) +3
...
**At will:** [Prestidigitation](compendium/spells/prestidigitation.md), [Speak with Animals](compendium/spells/speak-with-animals.md)

**1/day each:** [Bestow Curse](compendium/spells/bestow-curse.md), [Command](compendium/spells/command.md), [Crown of Madness](compendium/spells/crown-of-madness.md)

## Bonus Actions

***Unerring Tracker.*** Brusipha magically creates a psychic link with one creature she can see. For the next hour, Brusipha knows the current distance and direction to the target if it is on the same plane of existence. The link ends if Brusipha has the [incapacitated](rules/conditions.md#Incapacitated) condition or uses this ability on a different target.
