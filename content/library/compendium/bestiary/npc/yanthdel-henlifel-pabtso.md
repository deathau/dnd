...
aliases:
  - Yanthdel Henlifel
created: 2026-01-27T15:31:08.873+11:00
modified: 2026-01-27T16:12:05.045+11:00
tags:
...
_Source: Phandelver and Below: The Shattered Obelisk p. 114_
...
- **Skills** [Perception](rules/skills.md#Perception) +4, [Stealth](rules/skills.md#Stealth) +10
...
***Innate Spellcasting.*** Yanthdel's spellcasting ability is Charisma (spell save DC 12). It can innately cast the following spells, requiring no material components:
...
***Fey Ancestry.*** Yanthdel has advantage on saving throws against being [charmed](rules/conditions.md#Charmed), and magic can't put Yanthdel to sleep.

***Sunlight Sensitivity.*** While in sunlight, Yanthdel has disadvantage on attack rolls, as well as on Wisdom ([Perception](rules/skills.md#Perception)) checks that rely on sight.

## Actions

***Multiattack.*** Yanthdel makes two shortsword attacks.
...
***Parry.*** Yanthdel adds 3 to its AC against one melee attack that would hit it. To do so, Yanthdel must see the attacker and be wielding a melee weapon.
```
