...
aliases:
  - Ember
created: 2026-01-27T15:31:08.992+11:00
...
_Source: Monstrous Compendium Volume 2: Dragonlance Creatures p. 5_
...
- **Skills** [Perception](rules/skills.md#Perception) +16, [Religion](rules/skills.md#Religion) +10, [Stealth](rules/skills.md#Stealth) +14
...
***Calescent Aura.*** At the start of Ember's turn, Ember can force any number of creatures of his choice within 10 feet of himself to make a DC 22 Constitution saving throw. On a failed save, a creature takes 7 (2d6) fire damage and is [frightened](rules/conditions.md#Frightened) of Ember until the start of its next turn.
...
Legendary Action Uses: 3. Immediately after another creature's turn, Ember can expend a use to take one of the following actions. Ember regains all expended uses at the start of each of their turns.
