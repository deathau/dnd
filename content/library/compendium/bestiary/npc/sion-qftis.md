...
_Source: Quests from the Infinite Staircase p. 216_
...
- **Skills** [Arcana](rules/skills.md#Arcana) +3, [Perception](rules/skills.md#Perception) +4, [Stealth](rules/skills.md#Stealth) +6
...
***Affix Shadow.*** Sion targets a creature within 60 feet of himself that he can see. That target must make a DC 13 Charisma saving throw. On a failed save, the target has the [grappled](rules/conditions.md#Grappled) condition (escape DC 13) as its shadow wraps around it. Once the target escapes the grapple, its shadow returns to normal.
...
**1/day each:** [Darkness](compendium/spells/darkness.md), [Mirror Image](compendium/spells/mirror-image.md), [Silence](compendium/spells/silence.md)
