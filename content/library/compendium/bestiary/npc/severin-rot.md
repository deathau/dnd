...
aliases:
  - Severin
created: 2026-01-27T15:31:08.960+11:00
modified: 2026-01-27T16:12:05.102+11:00
tags:
...
_Source: The Rise of Tiamat p. 92_

```ad-statblock
title: Severin
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/RoT/Severin.webp#token)
...
- **Skills** [Arcana](rules/skills.md#Arcana) +7, [Religion](rules/skills.md#Religion) +7
...
- **Condition Immunities** While wearing the mask of the Dragon Queen: [charmed](rules/conditions.md#Charmed), [frightened](rules/conditions.md#Frightened), [poisoned](rules/conditions.md#Poisoned)
- **Languages** Common, Draconic, Infernal
- **Challenge** 11

## Traits

***Special Equipment.*** Severin has the [Mask of the Dragon Queen](compendium/items/mask-of-the-dragon-queen-rot.md).
...
***Hellish Chains (Costs 3 Actions).*** Severin targets one creature he can see within 30 feet of him. The target is wrapped in magical chains of fire and [restrained](rules/conditions.md#Restrained). The [restrained](rules/conditions.md#Restrained) target takes 21 (6d6) fire damage at the start of each of its turns. At the end of its turns, the target can make a DC 17 Strength saving throw, ending the effect on itself on a success.
```
