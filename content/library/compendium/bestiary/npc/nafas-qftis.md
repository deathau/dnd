...
aliases:
  - Nafas
created: 2026-01-27T15:31:07.885+11:00
modified: 2026-01-27T16:12:04.725+11:00
tags:
...
_Source: Quests from the Infinite Staircase p. 210_
...
- **Skills** [Perception](rules/skills.md#Perception) +11, [Performance](rules/skills.md#Performance) +13
...
***Noble Genie.*** Nafas doesn't suffer any of the penalties that normally follow casting the [Wish](compendium/spells/wish.md) spell to produce an effect other than duplicating another spell.
...
***Create Vortex.*** A 10-foot-radius, 60-foot-tall cylinder of swirling cosmic dust forms on a point Nafas can see within 120 feet of him. The vortex lasts as long as Nafas maintains [concentration](rules/conditions.md#Concentration) (as if [concentrating](rules/conditions.md#Concentration) on a spell). When the vortex appears, each creature other than Nafas in the vortex's area must make a DC 22 Strength saving throw. On a failed save, a creature takes 36 (8d8) force damage and has the [restrained](rules/conditions.md#Restrained) condition. On a successful save, a creature takes half as much damage only and moves to the nearest unoccupied space outside the vortex.

On subsequent turns, Nafas can use this action to move the vortex up to 60 feet. When the vortex enters a creature's space for the first time on a turn, the creature must make the same saving throw as when the vortex first appeared. Creatures [restrained](rules/conditions.md#Restrained) by the vortex move with it.

A creature [restrained](rules/conditions.md#Restrained) by the vortex, or another creature that can reach it, can use its action to make a DC 22 Strength check. On a successful check, the [restrained](rules/conditions.md#Restrained) creature is no longer [restrained](rules/conditions.md#Restrained) and moves to the nearest unoccupied space outside the vortex.
...
**At will:** [Detect Evil and Good](compendium/spells/detect-evil-and-good.md), [Detect Magic](compendium/spells/detect-magic.md), [Thaumaturgy](compendium/spells/thaumaturgy.md)

**3/day each:** [Create Food and Water](compendium/spells/create-food-and-water.md) (the food is always tasty), [Dispel Magic](compendium/spells/dispel-magic.md), [Invisibility](compendium/spells/invisibility.md), [Legend Lore](compendium/spells/legend-lore.md) (as an action), [Tongues](compendium/spells/tongues.md), [Wind Walk](compendium/spells/wind-walk.md) (as an action)

**1/day each:** [Gaseous Form](compendium/spells/gaseous-form.md), [Major Image](compendium/spells/major-image.md), [Teleport](compendium/spells/teleport.md), [Wish](compendium/spells/wish.md)
...
![Nafas](compendium/bestiary/legendary-group/nafas-qftis.md)
```
