...
aliases:
  - Mirt
created: 2026-01-27T15:31:08.416+11:00
modified: 2026-01-27T16:12:04.757+11:00
tags:
...
_Source: Waterdeep: Dragon Heist p. 211_
...
- **Armor Class** 16 ([bracers of defense](compendium/items/bracers-of-defense.md))
...
- **Skills** [Acrobatics](rules/skills.md#Acrobatics) +8, [Athletics](rules/skills.md#Athletics) +8, [Perception](rules/skills.md#Perception) +5, [Persuasion](rules/skills.md#Persuasion) +6, [Stealth](rules/skills.md#Stealth) +8
- **Senses** passive Perception 15
- **Gear** [+1 dagger](compendium/items/1-weapon.md), [+1 longsword](compendium/items/1-weapon.md)
- **Languages** Common, Dwarvish
- **Challenge** 9

## Traits

***Special Equipment.*** Mirt wears [bracers of defense](compendium/items/bracers-of-defense.md) and a [ring of regeneration](compendium/items/ring-of-regeneration.md). He wields a [+1 longsword](compendium/items/1-weapon.md) and a [+1 dagger](compendium/items/1-weapon.md).

***Brute.*** A melee weapon deals one extra die of its damage when Mirt hits with it (included in the attacks below).

***Evasion.*** If he is subjected to an effect that allows him to make a Dexterity saving throw to take only half damage, Mirt instead takes no damage if he succeeds on the saving throw, and only half damage if he fails. He can't use this trait if he's [incapacitated](rules/conditions.md#Incapacitated).

***Sneak Attack (1/Turn).*** Mirt deals an extra 14 (4d6) damage when he hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Mirt's that isn't [incapacitated](rules/conditions.md#Incapacitated) and Mirt doesn't have disadvantage on the attack roll.
