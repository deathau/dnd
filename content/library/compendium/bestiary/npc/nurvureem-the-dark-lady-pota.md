...
created: 2026-01-27T15:31:09.141+11:00
modified: 2026-01-27T16:12:05.220+11:00
tags:
...
_Source: Princes of the Apocalypse p. 180_

```ad-statblock
title: Nurvureem, The Dark Lady
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PotA/Nurvureem%2C%20The%20Dark%20Lady.webp#token)
...
- **Skills** [Perception](rules/skills.md#Perception) +11, [Stealth](rules/skills.md#Stealth) +7
- **Senses** [blindsight](rules/senses.md#Blindsight) 60 ft., [darkvision](rules/senses.md#Darkvision) 120 ft., passive Perception 21
...
***Shadow Stealth.*** While in dim light or darkness, the dragon can take the [Hide](rules/actions.md#Hide) action as a bonus action.
...
Legendary Action Uses: 3. Immediately after another creature's turn, Nurvureem can expend a use to take one of the following actions. Nurvureem regains all expended uses at the start of each of their turns.

***Detect.*** Nurvureem makes a Wisdom ([Perception](rules/skills.md#Perception)) check.

***Tail Attack.*** Nurvureem makes a tail attack.

***Wing Attack (Costs 2 Actions).*** Nurvureem beats its wings. Each creature within 10 feet of Nurvureem must succeed on a DC 19 Dexterity saving throw or take 13 (2d6 + 6) bludgeoning damage and be knocked [prone](rules/conditions.md#Prone). Nurvureem can then fly up to half its flying speed.
```
