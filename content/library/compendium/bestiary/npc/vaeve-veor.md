...
aliases:
  - Vaeve
created: 2026-01-27T15:31:08.718+11:00
modified: 2026-01-27T16:12:04.955+11:00
tags:
...
_Source: Vecna: Eve of Ruin p. 175_

```ad-statblock
title: Vaeve
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VEoR/Vaeve.webp#token)
...
***Spellcasting.*** Vaeve is a 10th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 14, +6 to hit with spell attacks). Vaeve has the following wizard spells prepared:
...
***Innate Spellcasting.*** Vaeve's spellcasting ability is Charisma (spell save DC 12). It can innately cast the following spells, requiring no material components:
...
***Fey Ancestry.*** Vaeve has advantage on saving throws against being [charmed](rules/conditions.md#Charmed), and magic can't put Vaeve to sleep.

***Sunlight Sensitivity.*** While in sunlight, Vaeve has disadvantage on attack rolls, as well as on Wisdom ([Perception](rules/skills.md#Perception)) checks that rely on sight.
