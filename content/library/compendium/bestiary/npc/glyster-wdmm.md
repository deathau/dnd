...
aliases:
  - Glyster
created: 2026-01-27T15:31:08.801+11:00
modified: 2026-01-27T16:12:05.010+11:00
tags:
...
```ad-statblock
title: Glyster
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Glyster.webp#token)
...
Legendary Action Uses: 3. Immediately after another creature's turn, Glyster can expend a use to take one of the following actions. Glyster regains all expended uses at the start of each of their turns.

***Detect.*** Glyster makes a Wisdom ([Perception](rules/skills.md#Perception)) check.

***Tail Attack.*** Glyster makes a tail attack.

***Wing Attack (Costs 2 Actions).*** Glyster beats its wings. Each creature within 10 feet of Glyster must succeed on a DC 20 Dexterity saving throw or take 14 (2d6 + 7) bludgeoning damage and be knocked [prone](rules/conditions.md#Prone). Glyster can then fly up to half its flying speed.
```
