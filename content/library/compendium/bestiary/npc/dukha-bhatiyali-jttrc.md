...
_Source: Journeys through the Radiant Citadel p. 124_

```ad-statblock
title: Dukha Bhatiyali
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/JttRC/Dukha%20Bhatiyali.webp#token)
...
***Multiattack (Humanoid or Hybrid Form Only).*** In humanoid form, Dukha makes two scimitar attacks or two longbow attacks. In hybrid form, it can attack like a humanoid or make two claw attacks.
