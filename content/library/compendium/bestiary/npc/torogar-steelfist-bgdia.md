...
aliases:
  - Torogar Steelfist
created: 2026-01-27T15:31:08.947+11:00
modified: 2026-01-27T16:05:47.296+11:00
tags:
...
_Source: Baldur's Gate: Descent Into Avernus p. 112_

```ad-statblock
title: Torogar Steelfist
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BGDIA/Torogar%20Steelfist.webp#token)
...
***Goring Rush.*** Immediately after using the [Dash](rules/actions.md#Dash) action, Torogar can make one melee attack with his horns.

***Labyrinthine Recall.*** Torogar can perfectly recall any path he has traveled.

***Rage (Recharges after a Short or Long Rest).*** As a bonus action, Torogar can enter a rage that lasts for 1 minute. The rage ends early if Torogar is knocked [unconscious](rules/conditions.md#Unconscious) or if his turn ends and he hasn't attacked a hostile creature or taken damage since his last turn. While raging, Torogar gains the following benefits:
...
***Special Equipment.*** Torogar wears [gauntlets of flaming fury](compendium/items/gauntlets-of-flaming-fury-bgdia.md) and a [belt of fire giant strength](compendium/items/belt-of-fire-giant-strength.md). Without the belt, his Strength is 21. He also carries a [soul coin](compendium/items/soul-coin-bgdia.md).
