...
aliases:
  - Yarnspinner
created: 2026-01-27T15:31:08.425+11:00
modified: 2026-01-27T16:12:04.762+11:00
tags:
...
_Source: Domains of Delight p. 22, The Wild Beyond the Witchlight_
...
- **Skills** [Perception](rules/skills.md#Perception) +13, [Stealth](rules/skills.md#Stealth) +7
...
***Web.*** Yarnspinner shoots webbing at one creature he can see within 120 feet of himself. The target must succeed on a DC 17 Strength saving throw or be [restrained](rules/conditions.md#Restrained) for 1 hour. The target can repeat the save at the end of each of its turns, ending the effect on itself on a success.
...
**At will:** [faerie fire](compendium/spells/faerie-fire.md), [speak with animals](compendium/spells/speak-with-animals.md)

**2/day each:** [animal friendship](compendium/spells/animal-friendship.md), [create food and water](compendium/spells/create-food-and-water.md), [revivify](compendium/spells/revivify.md)

**1/day each:** [awaken](compendium/spells/awaken.md) (as an action), [pass without trace](compendium/spells/pass-without-trace.md)
```
