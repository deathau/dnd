...
modified: 2026-01-27T16:12:04.639+11:00
tags:
...
_Source: Vecna: Eve of Ruin p. 49_

```ad-statblock
title: Grottenelle Stonecutter
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VEoR/Grottenelle%20Stonecutter.webp#token)
...
***Innate Spellcasting.*** Grottenelle
...
***Spellcasting.*** Grottenelle is a 9th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 14, +6 to hit with spell attacks). Grottenelle has the following wizard spells prepared:
...
***Gnome Cunning.*** Grottenelle

***Stone Camouflage.*** Grottenelle
