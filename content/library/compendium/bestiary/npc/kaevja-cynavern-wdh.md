...
modified: 2026-01-27T16:05:46.887+11:00
tags:
...
_Source: Waterdeep: Dragon Heist p. 158_

Previously a Red Wizard of Thay, this mage now studies magic under Manshoon.

```ad-statblock
title: Kaevja Cynavern
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Kaevja%20Cynavern.webp#token)
...
***Spellcasting.*** Kaevja is a 9th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 14, +6 to hit with spell attacks). Kaevja has the following wizard spells prepared:
...
**3rd level (3 slots):** [counterspell](compendium/spells/counterspell.md), [fireball](compendium/spells/fireball.md), [sending](compendium/spells/sending.md)
...
***Special Equipment.*** Kaevja carries a yellow [elemental gem](compendium/items/elemental-gem.md). As an action she can break the gem releasing an earth elemental under her command.
