...
aliases:
  - Oussa
created: 2026-01-27T15:31:08.999+11:00
modified: 2026-01-27T16:12:05.124+11:00
tags:
...
_Source: Tales from the Yawning Portal p. 157_

```ad-statblock
title: Oussa
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TftYP/Oussa.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Deception](rules/skills.md#Deception) +5, [Stealth](rules/skills.md#Stealth) +4
...
- **Gear** [longbow](compendium/items/longbow.md), [scimitar](compendium/items/scimitar.md)
...
***Shapechanger.*** Oussa can use its action to polymorph into a Medium snake, or back into its true form. Its statistics are the same in each form. Any equipment it is wearing or carrying isn't transformed. It doesn't change form if it dies.

***Magic Resistance.*** Oussa has advantage on saving throws against spells and other magical effects.

***Malison Type.*** Oussa has one of the following types:
...
***Multiattack (Yuan-ti Form Only).*** Oussa makes two ranged attacks or two melee attacks, but can constrict only once.
