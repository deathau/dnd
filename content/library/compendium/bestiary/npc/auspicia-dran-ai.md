...
_Source: Acquisitions Incorporated p. 208_
...
```ad-statblock
title: Auspicia Dran
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/AI/Auspicia%20Dran.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Athletics](rules/skills.md#Athletics) +5, [Perception](rules/skills.md#Perception) +3
- **Senses** passive Perception 13
- **Gear** [light crossbow](compendium/items/light-crossbow.md), [longsword](compendium/items/longsword.md)
