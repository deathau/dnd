...
aliases:
  - Dyrrn
created: 2026-01-27T15:31:08.426+11:00
...
_Source: Eberron: Rising from the Last War p. 288_
...
- **Skills** [Arcana](rules/skills.md#Arcana) +15, [History](rules/skills.md#History) +15, [Insight](rules/skills.md#Insight) +13, [Perception](rules/skills.md#Perception) +13
...
Legendary Action Uses: 3. Immediately after another creature's turn, Dyrrn can expend a use to take one of the following actions. Dyrrn regains all expended uses at the start of each of their turns.
