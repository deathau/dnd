...
aliases:
  - Zephyros
created: 2026-01-27T15:31:09.113+11:00
modified: 2026-01-27T16:12:05.189+11:00
tags:
...
_Source: Storm King's Thunder p. 33_
...
```ad-statblock
title: Zephyros
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Zephyros.webp#token)
...
- **Skills** [Insight](rules/skills.md#Insight) +8, [Perception](rules/skills.md#Perception) +8
...
***Keen Smell.*** Zephyros has advantage on Wisdom ([Perception](rules/skills.md#Perception)) checks that rely on smell.

## Actions

***Fling.*** Zephyros tries to throw a Small or Medium creature within 10 feet of it. The target must succeed on a DC 20 Dexterity saving throw or be hurled up to 60 feet horizontally in a direction of Zephyros's choice and land [prone](rules/conditions.md#Prone), taking 1d8 bludgeoning damage for every 10 feet it was thrown.

***Wind Aura.*** A magical aura of wind surrounds Zephyros. The aura is a 10-foot-radius sphere that lasts as long as he maintains [concentration](rules/conditions.md#Concentration) on it (as if [concentrating](rules/conditions.md#Concentration) on a spell). While the aura is in effect, Zephyros gains a +2 bonus to his AC against ranged weapon attacks, and all open flames within the aura are extinguished unless they are magical.
