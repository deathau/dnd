...
_Source: Mordenkainen Presents: Monsters of the Multiverse p. 148, Mordenkainen's Tome of Foes p. 149, Keys from the Golden Vault_
...
```ad-statblock
title: Graz'zt
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Graz%27zt.webp#token)
...
- **Skills** [Deception](rules/skills.md#Deception) +15, [Perception](rules/skills.md#Perception) +12, [Persuasion](rules/skills.md#Persuasion) +15
...
Legendary Action Uses: 3. Immediately after another creature's turn, Graz'zt can expend a use to take one of the following actions. Graz'zt regains all expended uses at the start of each of their turns.
