...
_Source: Eberron: Rising from the Last War p. 304_
...
- **Skills** [Arcana](rules/skills.md#Arcana) +18, [History](rules/skills.md#History) +18, [Insight](rules/skills.md#Insight) +14, [Religion](rules/skills.md#Religion) +18
...
Legendary Action Uses: 3. Immediately after another creature's turn, Sul Khatesh can expend a use to take one of the following actions. Sul Khatesh regains all expended uses at the start of each of their turns.

***Attack.*** Sul Khatesh makes two attacks with her Arcane Blast or one attack with her magic staff.

***Consume Magic (Costs 2 Actions).*** Sul Khatesh targets a creature within 120 feet of her who is [concentrating](rules/conditions.md#Concentration) on a spell. The target must succeed on a DC 26 Constitution saving throw or its [concentration](rules/conditions.md#Concentration) is broken on the spell, and Sul Khatesh gains 5 temporary hit points per level of that spell.
