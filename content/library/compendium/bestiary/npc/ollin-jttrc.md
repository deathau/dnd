...
aliases:
  - Ollin
created: 2026-01-27T15:31:07.859+11:00
...
_Source: Journeys through the Radiant Citadel p. 109_

```ad-statblock
title: Ollin
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/JttRC/Ollin.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Medicine](rules/skills.md#Medicine) +7, [Performance](rules/skills.md#Performance) +3, [Religion](rules/skills.md#Religion) +5
...
***Divine Eminence.*** As a bonus action, Ollin can expend a spell slot to cause its melee weapon attacks to magically deal an extra 10 (3d6) radiant damage to a target on a hit. This benefit lasts until the end of the turn. If Ollin expends a spell slot of 2nd level or higher, the extra damage increases by 1d6 for each level above 1st.
