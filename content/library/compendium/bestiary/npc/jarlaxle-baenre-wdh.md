...
aliases:
  - Jarlaxle Baenre
created: 2026-01-27T15:31:08.522+11:00
modified: 2026-01-27T16:12:04.826+11:00
tags:
...
_Source: Waterdeep: Dragon Heist p. 206_
...
- **Armor Class** 24 ([+3 leather armor](compendium/items/3-armor.md), Suave Defense)
...
- **Skills** [Acrobatics](rules/skills.md#Acrobatics) +11, [Athletics](rules/skills.md#Athletics) +6, [Deception](rules/skills.md#Deception) +14, [Perception](rules/skills.md#Perception) +8, [Sleight of Hand](rules/skills.md#Sleight%20of%20Hand) +11, [Stealth](rules/skills.md#Stealth) +16
- **Senses** [darkvision](rules/senses.md#Darkvision) 120 ft., passive Perception 18
- **Gear** [+3 rapier](compendium/items/3-weapon.md)
...
***Special Equipment.*** Jarlaxle wears [+3 leather armor](compendium/items/3-armor.md), a [hat of disguise](compendium/items/hat-of-disguise.md), a [bracer of flying daggers](compendium/items/bracer-of-flying-daggers-wdh.md), a [cloak of invisibility](compendium/items/cloak-of-invisibility.md), a [knave's eye patch](compendium/items/knaves-eye-patch-wdh.md), and a [ring of truth telling](compendium/items/ring-of-truth-telling-wdh.md). He wields a [+3 rapier](compendium/items/3-weapon.md) and carries a [portable hole](compendium/items/portable-hole.md) and a [wand of web](compendium/items/wand-of-web.md). His hat is adorned with a [feather of diatryma summoning](compendium/items/feather-of-diatryma-summoning-wdh.md).

***Evasion.*** If he is subjected to an effect that allows him to make a Dexterity saving throw to take only half damage, Jarlaxle instead takes no damage if he succeeds on the saving throw, and only half damage if he fails. He can't use this trait if he's [incapacitated](rules/conditions.md#Incapacitated).

***Fey Ancestry.*** Jarlaxle has advantage on saving throws against being [charmed](rules/conditions.md#Charmed), and magic can't put him to sleep.
...
***Sneak Attack (1/Turn).*** Jarlaxle deals an extra 24 (7d6) damage when he hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of Jarlaxle's that isn't [incapacitated](rules/conditions.md#Incapacitated) and Jarlaxle doesn't have disadvantage on the attack roll.

***Suave Defense.*** While Jarlaxle is wearing light or no armor and wielding no shield, his AC includes his Charisma modifier.

***Sunlight Sensitivity.*** When not wearing his knave's eye patch, Jarlaxle has disadvantage on attack rolls, as well as on Wisdom ([Perception](rules/skills.md#Perception)) checks that rely on sight.
...
Legendary Action Uses: 3. Immediately after another creature's turn, Jarlaxle can expend a use to take one of the following actions. Jarlaxle regains all expended uses at the start of each of their turns.
