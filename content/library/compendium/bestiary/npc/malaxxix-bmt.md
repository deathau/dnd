...
aliases:
  - Malaxxix
created: 2026-01-27T15:31:08.923+11:00
modified: 2026-01-27T16:12:05.081+11:00
tags:
...
_Source: The Book of Many Things p. 173_
...
```ad-statblock
title: Malaxxix
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Malaxxix.webp#token)
...
- **Skills** [Arcana](rules/skills.md#Arcana) +12, [Athletics](rules/skills.md#Athletics) +12, [Perception](rules/skills.md#Perception) +11
...
- **Gear** [whip](compendium/items/whip.md)
...
***Whip.*** *Melee Weapon Attack:* +12 to hit, reach 30 ft., one creature. *Hit:* 15 (2d8 + 6) slashing damage, and the target has the [restrained](rules/conditions.md#Restrained) condition for 1 minute. The [restrained](rules/conditions.md#Restrained) target can make a DC 20 Strength saving throw at the end of each of its turns, ending the effect on itself on a success. Only one creature can be [restrained](rules/conditions.md#Restrained) by the whip at a time.

***Mezzoloth Vortex (Recharge 5-6).*** Malaxxix summons a vortex of whirling mezzoloths at a point it can see within 90 feet of itself. The vortex is a 30-foot-radius, 100-foot-high cylinder centered on that point. Each creature other than Malaxxix in that area must make a DC 20 Dexterity saving throw. On a failed save, a creature takes 35 (10d6) force damage and has the [restrained](rules/conditions.md#Restrained) condition while within the cylinder. On a successful save, a creature takes half as much damage and is pushed to the nearest unoccupied space outside the cylinder. The vortex lasts until the start of Malaxxix's next turn.

## Legendary Actions

Legendary Action Uses: 3. Immediately after another creature's turn, Malaxxix can expend a use to take one of the following actions. Malaxxix regains all expended uses at the start of each of their turns.
...
![Malaxxix](compendium/bestiary/legendary-group/malaxxix-bmt.md)
```
