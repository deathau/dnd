...
aliases:
  - Ashtyrranthor
created: 2026-01-27T15:31:08.535+11:00
modified: 2026-01-27T16:12:04.833+11:00
tags:
...
_Source: Waterdeep: Dungeon of the Mad Mage p. 210_
...
- **Skills** [Perception](rules/skills.md#Perception) +13, [Stealth](rules/skills.md#Stealth) +6
- **Senses** [blindsight](rules/senses.md#Blindsight) 60 ft., [darkvision](rules/senses.md#Darkvision) 120 ft., passive Perception 23
...
**1/day each:** [alarm](compendium/spells/alarm.md), [detect magic](compendium/spells/detect-magic.md), [gaseous form](compendium/spells/gaseous-form.md), [misty step](compendium/spells/misty-step.md), [passwall](compendium/spells/passwall.md), [see invisibility](compendium/spells/see-invisibility.md)
...
Legendary Action Uses: 3. Immediately after another creature's turn, Ashtyrranthor can expend a use to take one of the following actions. Ashtyrranthor regains all expended uses at the start of each of their turns.

***Detect.*** Ashtyrranthor makes a Wisdom ([Perception](rules/skills.md#Perception)) check.

***Tail Attack.*** Ashtyrranthor makes a tail attack.

***Wing Attack (Costs 2 Actions).*** Ashtyrranthor beats its wings. Each creature within 10 feet of Ashtyrranthor must succeed on a DC 22 Dexterity saving throw or take 15 (2d6 + 8) bludgeoning damage and be knocked [prone](rules/conditions.md#Prone). Ashtyrranthor can then fly up to half its flying speed.
```
