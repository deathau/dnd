...
_Source: Phandelver and Below: The Shattered Obelisk p. 99_
...
- **Skills** [Insight](rules/skills.md#Insight) +5, [Perception](rules/skills.md#Perception) +5, [Stealth](rules/skills.md#Stealth) +10
...
***Mental Fortitude.*** Ruxithid has advantage on saving throws against the [charmed](rules/conditions.md#Charmed) and [frightened](rules/conditions.md#Frightened) conditions.
