...
aliases:
  - Beldora
created: 2026-01-27T15:31:08.687+11:00
modified: 2026-01-27T16:05:46.994+11:00
tags:
...
_Source: Storm King's Thunder p. 249_
...
```ad-statblock
title: Beldora
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Beldora.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Deception](rules/skills.md#Deception) +5, [Insight](rules/skills.md#Insight) +3, [Investigation](rules/skills.md#Investigation) +5, [Perception](rules/skills.md#Perception) +5, [Persuasion](rules/skills.md#Persuasion) +5
...
***Duck and Cover.*** Beldora adds 2 to her AC against one ranged attack that would hit her. To do so, Beldora must see the attacker and can't be [grappled](rules/conditions.md#Grappled) or [restrained](rules/conditions.md#Restrained).
```
