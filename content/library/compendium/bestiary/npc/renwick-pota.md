...
_Source: Princes of the Apocalypse p. 66_

```ad-statblock
title: Renwick
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/PotA/Renwick.webp#token)
...
Legendary Action Uses: 3. Immediately after another creature's turn, Renwick can expend a use to take one of the following actions. Renwick regains all expended uses at the start of each of their turns.
