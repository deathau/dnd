...
aliases:
  - Rak Tulkhesh
created: 2026-01-27T15:31:09.046+11:00
...
_Source: Eberron: Rising from the Last War p. 303_
...
```ad-statblock
title: Rak Tulkhesh
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ERLW/Rak%20Tulkhesh.webp#token)
...
- **Skills** [Athletics](rules/skills.md#Athletics) +17, [Intimidation](rules/skills.md#Intimidation) +16, [Perception](rules/skills.md#Perception) +14
...
Legendary Action Uses: 3. Immediately after another creature's turn, Rak Tulkhesh can expend a use to take one of the following actions. Rak Tulkhesh regains all expended uses at the start of each of their turns.
