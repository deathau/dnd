...
_Source: Tomb of Annihilation p. 33_

```ad-statblock
title: Azaka Stormfang
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/ToA/Azaka%20Stormfang.webp#token)
...
***Keen Hearing and Smell.*** The Azaka has advantage on Wisdom ([Perception](rules/skills.md#Perception)) checks that rely on hearing or smell.

***Pounce (Tiger or Hybrid Form Only).*** If the Azaka moves at least 15 feet straight toward a creature and then hits it with a claw attack on the same turn, that target must succeed on a DC 14 Strength saving throw or be knocked [prone](rules/conditions.md#Prone). If the target is [prone](rules/conditions.md#Prone), the Azaka can make one bite attack against it as a bonus action.
