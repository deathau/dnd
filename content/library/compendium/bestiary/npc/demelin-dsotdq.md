...
aliases:
  - Demelin
created: 2026-01-27T15:31:09.160+11:00
...
_Source: Dragonlance: Shadow of the Dragon Queen p. 139_

```ad-statblock
title: Demelin
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/DSotDQ/Demelin.webp#token)
...
***Spellcasting.*** Demelin is an 18th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 17, +9 to hit with spell attacks). Demelin can cast [disguise self](compendium/spells/disguise-self.md) and [invisibility](compendium/spells/invisibility.md) at will and has the following wizard spells prepared:
...
*Demelin casts these spells on itself before combat.

***Magic Resistance.*** Demelin has advantage on saving throws against spells and other magical effects.
