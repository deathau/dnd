...
modified: 2026-01-27T16:12:04.847+11:00
tags:
...
_Source: Critical Role: Call of the Netherdeep p. 191_
...
- **Skills** [Athletics](rules/skills.md#Athletics) +7, [Insight](rules/skills.md#Insight) +6, [Perception](rules/skills.md#Perception) +6, [Persuasion](rules/skills.md#Persuasion) +5
...
***Push.*** Once during each of her turns, after hitting a creature with an attack, Maggie can force the target to make a DC 15 Strength saving throw; on a failed save, the target is pushed up to 10 feet horizontally away from Maggie and knocked [prone](rules/conditions.md#Prone).
