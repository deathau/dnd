...
_Source: Dragonlance: Shadow of the Dragon Queen p. 79_

```ad-statblock
title: Wyhan
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/DSotDQ/Wyhan.webp#token)
...
***Spellcasting.*** Wyhan is a 9th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 14, +6 to hit with spell attacks). Wyhan has the following wizard spells prepared:
