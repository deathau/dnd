...
_Source: Strixhaven: A Curriculum of Chaos p. 218_
...
- **Skills** [Arcana](rules/skills.md#Arcana) +23, [Investigation](rules/skills.md#Investigation) +23, [Nature](rules/skills.md#Nature) +16, [Perception](rules/skills.md#Perception) +18
...
Legendary Action Uses: 3. Immediately after another creature's turn, Tanazir can expend a use to take one of the following actions. Tanazir regains all expended uses at the start of each of their turns.
