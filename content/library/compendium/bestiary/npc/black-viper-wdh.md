...
aliases:
  - Black Viper
created: 2026-01-27T15:31:08.605+11:00
modified: 2026-01-27T16:12:04.882+11:00
tags:
...
_Source: Waterdeep: Dragon Heist p. 196_
...
```ad-statblock
title: Black Viper
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDH/Black%20Viper.webp#token)
...
- **Skills** [Acrobatics](rules/skills.md#Acrobatics) +7, [Athletics](rules/skills.md#Athletics) +3, [Perception](rules/skills.md#Perception) +3, [Sleight of Hand](rules/skills.md#Sleight%20of%20Hand) +7, [Stealth](rules/skills.md#Stealth) +7
- **Senses** passive Perception 13
- **Gear** [hand crossbow](compendium/items/hand-crossbow.md), [rapier](compendium/items/rapier.md)
- **Languages** Common, Thieves' cant
- **Challenge** 5

## Traits

***Cunning Action.*** On each of her turns, the Black Viper can use a bonus action to take the [Dash](rules/actions.md#Dash), [Disengage](rules/actions.md#Disengage), or [Hide](rules/actions.md#Hide) action.

***Evasion.*** If the Black Viper is subjected to an effect that allows her to make a Dexterity saving throw to take only half damage, she instead takes no damage if she succeeds on the saving throw, and only half damage if she fails. She can't use this trait if she's [incapacitated](rules/conditions.md#Incapacitated).

***Sneak Attack (1/Turn).*** The Black Viper deals an extra 14 (4d6) damage when she hits a target with a weapon attack and has advantage on the attack roll, or when the target is within 5 feet of an ally of the Black Viper that isn't [incapacitated](rules/conditions.md#Incapacitated) and the Black Viper doesn't have disadvantage on the attack roll.
