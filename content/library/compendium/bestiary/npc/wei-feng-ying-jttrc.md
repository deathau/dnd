...
aliases:
  - Wei Feng Ying
created: 2026-01-27T15:31:07.801+11:00
modified: 2026-01-27T16:12:04.653+11:00
tags:
...
_Source: Journeys through the Radiant Citadel p. 188_

```ad-statblock
title: Wei Feng Ying
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/JttRC/Wei%20Feng%20Ying.webp#token)
...
***Spellcasting.*** Wei Feng is an 18th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 17, +9 to hit with spell attacks). Wei Feng can cast [disguise self](compendium/spells/disguise-self.md) and [invisibility](compendium/spells/invisibility.md) at will and has the following wizard spells prepared:
...
*Wei Feng casts these spells on itself before combat.

***Magic Resistance.*** Wei Feng has advantage on saving throws against spells and other magical effects.
