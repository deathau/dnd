...
aliases:
  - Agdon Longscarf
created: 2026-01-27T15:31:08.473+11:00
modified: 2026-01-27T16:12:04.799+11:00
tags:
...
_Source: The Wild Beyond the Witchlight p. 73_
...
- **Armor Class** 19 ([studded leather](compendium/items/studded-leather-armor.md), [shield](compendium/items/shield.md))
- **Hit Points** 36 (`8d8`)
...
- **Skills** [Acrobatics](rules/skills.md#Acrobatics) +7, [Perception](rules/skills.md#Perception) +6, [Sleight of Hand](rules/skills.md#Sleight%20of%20Hand) +7, [Stealth](rules/skills.md#Stealth) +7
...
***Evasion.*** If Agdon is subjected to an effect that allows him to make a Dexterity saving throw to take only half damage, he instead takes no damage if he succeeds on the saving throw and only half damage if he fails, provided he isn't [incapacitated](rules/conditions.md#Incapacitated).
...
***Branding Iron.*** *Melee Weapon Attack:* +7 to hit, reach 5 ft., one target. *Hit:* 10 (3d6) fire damage, and the target is magically branded. Agdon is [invisible](rules/conditions.md#Invisible) to creatures branded in this way. The brand disappears after 24 hours, or it can be removed from a creature or object by any spell that ends a curse.

***Dagger.*** *Melee  or Ranged Weapon Attack:* +7 to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* 7 (1d4 + 5) piercing damage.

## Bonus Actions

***Quick Fingers.*** Agdon targets one creature within 5 feet of him that he can see and makes a Dexterity ([Sleight of Hand](rules/skills.md#Sleight%20of%20Hand)) check, with a DC equal to 1 + the target's passive Wisdom ([Perception](rules/skills.md#Perception)) score. On a successful check, Agdon pilfers one object weighing 1 pound or less that the target has in its possession but not in its grasp, without the target noticing the theft.
