...
aliases:
  - Olhydra
created: 2026-01-27T15:31:09.169+11:00
modified: 2026-01-27T16:12:05.235+11:00
tags:
...
_Source: Princes of the Apocalypse p. 218_
...
***Slam.*** *Melee Weapon Attack:* +11 to hit, reach 10 ft., one target. *Hit:* 21 (3d10 + 5) bludgeoning damage, and the target is [grappled](rules/conditions.md#Grappled) (escape DC 19). Olhydra can grapple up to four targets. When Olhydra moves, all creatures she is grappling move with her.

***Water Jet.*** *Ranged Weapon Attack:* +12 to hit, range 120 ft., one target. *Hit:* 21 (6d6) bludgeoning damage, and the target is knocked [prone](rules/conditions.md#Prone) if it fails a DC 19 Strength saving throw.

***Summon Elementals (1/Day).*** Olhydra summons up to three [water elementals](compendium/bestiary/elemental/water-elemental.md) and loses 30 hit points for each elemental she summons. Summoned elementals have maximum hit points, appear within 100 feet of Olhydra, and disappear if Olhydra is reduced to 0 hit points.

## Legendary Actions

Legendary Action Uses: 3. Immediately after another creature's turn, Olhydra can expend a use to take one of the following actions. Olhydra regains all expended uses at the start of each of their turns.
