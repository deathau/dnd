...
modified: 2026-01-27T16:05:46.704+11:00
tags:
...
_Source: Hoard of the Dragon Queen p. 87_

```ad-statblock
title: Leosin Erlanthar
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/HotDQ/Leosin%20Erlanthar.webp#token)
...
***5etools Note.*** Leosin Erlanthar is presented in Hoard of the Dragon Queen as a half-elf monk. The [martial arts adept](compendium/bestiary/humanoid/martial-arts-adept-mpmm.md) stat block from "Volo's Guide to Monsters" has been provided here for ease of use.
...
- The target must succeed on a DC 13 Constitution saving throw or be [stunned](rules/conditions.md#Stunned) until the end of the adept's next turn.  
