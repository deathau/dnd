...
aliases:
  - Nedylene
created: 2026-01-27T15:31:09.051+11:00
modified: 2026-01-27T16:12:05.162+11:00
tags:
...
_Source: Tales from the Yawning Portal p. 209_

```ad-statblock
title: Nedylene
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TftYP/Nedylene.webp#token)
...
- **Skills** [Insight](rules/skills.md#Insight) +6, [Perception](rules/skills.md#Perception) +6, [Religion](rules/skills.md#Religion) +4, [Stealth](rules/skills.md#Stealth) +5
...
***Special Equipment.*** Nedylene carries a [staff of swarming insects](compendium/items/staff-of-swarming-insects.md).

***Fey Ancestry.*** Nedylene has advantage on saving throws against being [charmed](rules/conditions.md#Charmed), and magic can't put Nedylene to sleep.

***Sunlight Sensitivity.*** While in sunlight, Nedylene has disadvantage on attack rolls, as well as on Wisdom ([Perception](rules/skills.md#Perception)) checks that rely on sight.
...
***Summon Demon (1/Day).*** Nedylene attempts to magically summon a [yochlol](compendium/bestiary/fiend/yochlol.md) with a 30 percent chance of success. If the attempt fails, Nedylene takes 5 (1d10) psychic damage. Otherwise, the summoned demon appears in an unoccupied space within 60 feet of its summoner, acts as an ally of its summoner, and can't summon other demons. It remains for 10 minutes, until it or its summoner dies, or until its summoner dismisses it as an action.
```
