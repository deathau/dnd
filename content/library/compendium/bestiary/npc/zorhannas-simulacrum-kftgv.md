...
```ad-statblock
title: Zorhanna's Simulacrum
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/KftGV/Zorhanna%27s%20Simulacrum.webp#token)
...
- **Languages** Common, Deep Speech (when it is angry or frustrated), Draconic, Elvish, Gnomish, Sylvan
- **Challenge** 12

## Traits

***Spellcasting.*** The simulacrum is an 18th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 17, +9 to hit with spell attacks). The simulacrum can cast [disguise self](compendium/spells/disguise-self.md) and [invisibility](compendium/spells/invisibility.md) at will and has the following wizard spells prepared:
