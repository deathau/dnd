...
_Source: Waterdeep: Dungeon of the Mad Mage p. 273_

```ad-statblock
title: Stalagma Steelshadow
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Stalagma%20Steelshadow.webp#token)
...
- **Skills** [Arcana](rules/skills.md#Arcana) +8, [History](rules/skills.md#History) +8, [Perception](rules/skills.md#Perception) +11, [Stealth](rules/skills.md#Stealth) +5
...
Legendary Action Uses: 3. Immediately after another creature's turn, Stalagma can expend a use to take one of the following actions. Stalagma regains all expended uses at the start of each of their turns.
