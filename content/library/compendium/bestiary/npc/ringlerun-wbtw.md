...
aliases:
  - Ringlerun
created: 2026-01-27T15:31:07.863+11:00
modified: 2026-01-27T16:12:04.695+11:00
tags:
...
_Source: The Wild Beyond the Witchlight p. 227_
...
- **Armor Class** 12 ([staff of power](compendium/items/staff-of-power.md))
...
***Special Equipment.*** Ringlerun wields a [staff of power](compendium/items/staff-of-power.md). It has 20 charges when fully charged and regains 2d8 + 4 expended charges daily at dawn. If its last charge is expended, roll a d20. On a 1, the staff retains its +2 bonus to attack and damage rolls but loses its other properties; on a 20, it regains 1d8 + 2 charges.

## Actions

***Multiattack.*** Ringlerun makes three [staff of power](compendium/items/staff-of-power.md) or Freezing Ray attacks. He can replace one of those attacks with a use of Spellcasting.
...
**3/day each:** [charm person](compendium/spells/charm-person.md), [detect magic](compendium/spells/detect-magic.md), [sleep](compendium/spells/sleep.md)

**1/day each:** [banishment](compendium/spells/banishment.md), [dispel magic](compendium/spells/dispel-magic.md), [fly](compendium/spells/fly.md), [knock](compendium/spells/knock.md)
```
