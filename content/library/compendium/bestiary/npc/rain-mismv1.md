...
_Source: Misplaced Monsters: Volume 1 p. 8_
...
- **Skills** [Acrobatics](rules/skills.md#Acrobatics) +3, [Insight](rules/skills.md#Insight) +7, [Stealth](rules/skills.md#Stealth) +3
...
***Nimble Escape.*** Rain takes either the [Disengage](rules/actions.md#Disengage) or the [Hide](rules/actions.md#Hide) action.
```
