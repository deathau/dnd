...
aliases:
  - Emerald Greatwyrm
created: 2026-01-27T15:31:09.094+11:00
modified: 2026-01-27T16:12:05.186+11:00
tags:
...
_Source: Fizban's Treasury of Dragons p. 201_
...
```ad-statblock
title: Emerald Greatwyrm
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/FTD/Emerald%20Greatwyrm.webp#token)
...
- **Skills** [Arcana](rules/skills.md#Arcana) +26, [History](rules/skills.md#History) +18, [Perception](rules/skills.md#Perception) +15
- **Senses** [truesight](rules/senses.md#Truesight) 120 ft., passive Perception 25
- **Damage Immunities** psychic
- **Condition Immunities** [charmed](rules/conditions.md#Charmed), [frightened](rules/conditions.md#Frightened), [poisoned](rules/conditions.md#Poisoned), [prone](rules/conditions.md#Prone)
...
Legendary Action Uses: 3. Immediately after another creature's turn, the emerald greatwyrm can expend a use to take one of the following actions. The emerald greatwyrm regains all expended uses at the start of each of its turns.
