...
Legendary Action Uses: 3. Immediately after another creature's turn, the amethyst greatwyrm can expend a use to take one of the following actions. The amethyst greatwyrm regains all expended uses at the start of each of its turns.
