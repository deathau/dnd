...
Legendary Action Uses: 3. Immediately after another creature's turn, the brass greatwyrm can expend a use to take one of the following actions. The brass greatwyrm regains all expended uses at the start of each of its turns.
