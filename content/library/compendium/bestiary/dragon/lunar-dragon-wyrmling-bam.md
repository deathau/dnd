...
created: 2026-01-27T15:49:10.628+11:00
...
_Source: Boo's Astral Menagerie p. 35_
...
***Phase (2/Day).*** The dragon becomes partially incorporeal for as long as it maintains [concentration](rules/conditions.md#Concentration) on the effect (as if [concentrating](rules/conditions.md#Concentration) on a spell). While partially incorporeal, the dragon has resistance to bludgeoning, piercing, and slashing damage.
```
