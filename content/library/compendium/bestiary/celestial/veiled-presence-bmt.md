...
aliases:
  - Veiled Presence
created: 2026-01-27T15:31:08.658+11:00
modified: 2026-01-27T16:12:04.911+11:00
tags:
...
_Source: The Book of Many Things p. 48_
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Veiled%20Presence.webp#token)
...
- **Skills** [Perception](rules/skills.md#Perception) +12, [Stealth](rules/skills.md#Stealth) +21
...
***Revelation.*** The veiled presence reveals a glimpse of its otherworldly nature to a creature it can see within 30 feet of itself. The target must succeed on a DC 22 Wisdom saving throw or have the [paralyzed](rules/conditions.md#Paralyzed) condition until the end of its next turn, after which the target is immune to this Revelation for 24 hours.
...
Legendary Action Uses: 3. Immediately after another creature's turn, the veiled presence can expend a use to take one of the following actions. The veiled presence regains all expended uses at the start of each of its turns.
