...
aliases:
  - Archaic
created: 2026-01-27T15:31:09.052+11:00
...
_Source: Strixhaven: A Curriculum of Chaos p. 184_
...
- **Skills** [Arcana](rules/skills.md#Arcana) +20, [Deception](rules/skills.md#Deception) +11, [History](rules/skills.md#History) +20, [Perception](rules/skills.md#Perception) +13
...
Legendary Action Uses: 3. Immediately after another creature's turn, the archaic can expend a use to take one of the following actions. The archaic regains all expended uses at the start of each of its turns.
