...
created: 2026-01-27T15:31:08.733+11:00
modified: 2026-01-27T16:12:04.962+11:00
tags:
...
_Source: The Book of Many Things p. 163_
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Grim%20Champion%20of%20Pestilence.webp#token)
...
- **Skills** [Arcana](rules/skills.md#Arcana) +8, [Perception](rules/skills.md#Perception) +7, [Stealth](rules/skills.md#Stealth) +9
...
***Plague Bolt.*** *Ranged Spell Attack:* +10 to hit, range 120 ft., one target. *Hit:* 23 (4d8 + 5) poison damage, and the target has the [poisoned](rules/conditions.md#Poisoned) condition until the start of the champion's next turn.
...
**At will:** [Detect Magic](compendium/spells/detect-magic.md), [Mage Armor](compendium/spells/mage-armor.md) (self only)

**2/day each:** [Blight](compendium/spells/blight.md), [Blindness/Deafness](compendium/spells/blindness-deafness.md)

**1/day each:** [Cloudkill](compendium/spells/cloudkill.md), [Contagion](compendium/spells/contagion.md)

## Legendary Actions

Legendary Action Uses: 3. Immediately after another creature's turn, the grim champion of pestilence can expend a use to take one of the following actions. The grim champion of pestilence regains all expended uses at the start of each of its turns.
