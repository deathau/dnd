...
modified: 2026-01-27T16:12:04.816+11:00
tags:
...
_Source: Ghosts of Saltmarsh p. 233, Locathah Rising_
...
***Unarmed Strike.*** *Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 7 (1d8 + 3) bludgeoning damage, and the target must succeed on a DC 12 Constitution saving throw or contract [bluerot](rules/diseases.md#Bluerot) (see the "Bluerot" in notes).
