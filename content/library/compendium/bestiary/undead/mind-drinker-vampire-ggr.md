...
_Source: Guildmasters' Guide to Ravnica p. 224_
...
- **Skills** [Deception](rules/skills.md#Deception) +4, [Insight](rules/skills.md#Insight) +3, [Perception](rules/skills.md#Perception) +3, [Stealth](rules/skills.md#Stealth) +6
...
***Shadow Stealth.*** While in dim light or darkness, the vampire can take the [Hide](rules/actions.md#Hide) action as a bonus action.

***Sunlight Sensitivity.*** While in sunlight, the vampire has disadvantage on attack rolls, as well as on Wisdom ([Perception](rules/skills.md#Perception)) checks that rely on sight.
