...
modified: 2026-01-27T16:05:47.186+11:00
tags:
...
_Source: The Tortle Package p. 22_
...
***Venomous Claws.*** *Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 4 (1d4 + 2) slashing damage plus 2 (1d4) poison damage, and the target must succeed on a DC 11 Constitution saving throw or be [poisoned](rules/conditions.md#Poisoned) until the end of the target's next turn.
```
