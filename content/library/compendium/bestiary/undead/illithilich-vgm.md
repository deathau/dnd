...
The lich magically emits psychic energy in a 60-foot cone. Each creature in that area must succeed on a DC 18 Intelligence saving throw or take `dice:5d8+5|noform|noparens|avg|text(27)` (`5d8 + 5`) psychic damage and be [stunned](rules/conditions.md#Stunned) for 1 minute. A creature can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.
...
```ad-statblock
title: Illithilich
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VGM/Illithilich.webp#token)
...
- **Skills** [Arcana](rules/skills.md#Arcana) +19, [History](rules/skills.md#History) +12, [Insight](rules/skills.md#Insight) +9, [Perception](rules/skills.md#Perception) +9
...
Legendary Action Uses: 3. Immediately after another creature's turn, the illithilich can expend a use to take one of the following actions. The illithilich regains all expended uses at the start of each of its turns.
