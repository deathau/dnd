...
```ad-statblock
title: Priest of Osybus (Dread Boon)
...
***Dread Boon.*** Eerie whispers can now be heard around the priest. Any non-Undead creature that starts its turn within 30 feet of the priest must succeed on a DC 15 Wisdom saving throw or be [frightened](rules/conditions.md#Frightened) of the priest until the start of the creature's next turn.
