...
```ad-statblock
title: Trapper
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Trapper.webp#token)
...
- **Senses** [blindsight](rules/senses.md#Blindsight) 30 ft., [darkvision](rules/senses.md#Darkvision) 60 ft., passive Perception 11
- **Languages** —
- **Challenge** 3
