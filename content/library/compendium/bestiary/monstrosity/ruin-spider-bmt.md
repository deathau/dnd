...
modified: 2026-01-27T16:12:04.800+11:00
tags:
...
_Source: The Book of Many Things p. 182_
...
```ad-statblock
title: Ruin Spider
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/BMT/Ruin%20Spider.webp#token)
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Stealth](rules/skills.md#Stealth) +10
...
***Web (Recharge 5-6).*** *Ranged Weapon Attack:* +7 to hit, range 30/60 ft., one creature. *Hit:* The target has the [restrained](rules/conditions.md#Restrained) condition. As an action, a [restrained](rules/conditions.md#Restrained) target can make a DC 13 Strength check, bursting the webbing on a successful check. The webbing can also be destroyed (AC 10; 5 hit points; vulnerability to fire damage; immunity to acid, bludgeoning, poison, and psychic damage).
```
