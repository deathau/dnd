...
aliases:
  - Crag Cat
created: 2026-01-27T15:31:09.123+11:00
...
_Source: Storm King's Thunder p. 240, Icewind Dale: Rime of the Frostmaiden_
...
```ad-statblock
title: Crag Cat
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/SKT/Crag%20Cat.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Stealth](rules/skills.md#Stealth) +7, [Perception](rules/skills.md#Perception) +4
...
***Pounce.*** If the cat moves at least 20 feet straight toward a creature then hits it with a claw attack on the same turn, that target must succeed on a DC13 Strength saving throw or be knocked [prone](rules/conditions.md#Prone). If the target is [prone](rules/conditions.md#Prone), the cat can make one bite attack against it as a bonus action.
