...
aliases:
  - Asteroid Spider
created: 2026-01-27T15:31:08.737+11:00
modified: 2026-01-27T16:12:04.964+11:00
tags:
...
_Source: Monstrous Compendium Volume 1: Spelljammer Creatures p. 3_
...
- **Skills** [Perception](rules/skills.md#Perception) +11, [Stealth](rules/skills.md#Stealth) +5
- **Senses** [blindsight](rules/senses.md#Blindsight) 120 ft. while the spider's eyes are closed, [darkvision](rules/senses.md#Darkvision) 120 ft., passive Perception 21
- **Languages** —
- **Challenge** 15

## Traits

***False Appearance.*** If the spider is motionless, has its eyes and mouth closed, and has its legs wrapped around its body at the start of combat, it has advantage on its initiative roll. Moreover, if a creature hasn't observed the spider move or act, that creature must succeed on a DC 18 Intelligence ([Investigation](rules/skills.md#Investigation)) check to discern that the spider is anything other than an asteroid.
...
***Web Strand.*** *Ranged Weapon Attack:* +13 to hit, reach 120 ft., one creature. *Hit:* The target is [grappled](rules/conditions.md#Grappled) (escape DC 18). The web strand can be attacked and destroyed (AC 12; 20 hit points; vulnerability to fire damage; immunity to bludgeoning, poison, and psychic damage). The spider can grapple up to six creatures at a time using its web strands.

***Reel.*** The spider pulls each creature [grappled](rules/conditions.md#Grappled) by it up to 60 feet straight toward itself.

## Bonus Actions

***Snare Ship (1/Day).*** The spider weaves a magical web around a spelljamming ship it can see within 120 feet of itself. The web lasts for 1 minute and suppresses the magic of any spelljamming helm aboard the ship. Decks and other surfaces of the ship that aren't enclosed become difficult terrain until the effect ends. The web is impervious to damage but is destroyed by a successful casting of [dispel magic](compendium/spells/dispel-magic.md) (DC 18).
```
