...
aliases:
  - Carrion Crawler
created: 2026-01-27T15:31:08.943+11:00
modified: 2026-01-27T16:12:05.092+11:00
tags:
...
_Source: Monster Manual p. 37, Tales from the Yawning Portal, Tomb of Annihilation, Waterdeep: Dragon Heist, Waterdeep: Dungeon of the Mad Mage, Dragon of Icespire Peak, Baldur's Gate: Descent Into Avernus, Icewind Dale: Rime of the Frostmaiden, The Book of Many Things, Quests from the Infinite Staircase, Out of the Abyss, The Tortle Package_
...
***Tentacles.*** *Melee Weapon Attack:* +8 to hit, reach 10 ft., one creature. *Hit:* 4 (1d4 + 2) poison damage, and the target must succeed on a DC 13 Constitution saving throw or be [poisoned](rules/conditions.md#Poisoned) for 1 minute. Until this poison ends, the target is [paralyzed](rules/conditions.md#Paralyzed). The target can repeat the saving throw at the end of each of its turns, ending the poison on itself on a success.
