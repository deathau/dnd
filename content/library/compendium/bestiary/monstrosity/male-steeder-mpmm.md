...
```ad-statblock
title: Male Steeder
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Male%20Steeder.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Stealth](rules/skills.md#Stealth) +5, [Perception](rules/skills.md#Perception) +4
