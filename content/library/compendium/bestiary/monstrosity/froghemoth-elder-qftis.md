...
aliases:
  - Froghemoth Elder
created: 2026-01-27T15:31:08.796+11:00
...
_Source: Quests from the Infinite Staircase p. 198_
...
To learn more about froghemoths, see _Mordenkainen Presents: Monsters of the Multiverse_.
...
- **Skills** [Perception](rules/skills.md#Perception) +12, [Stealth](rules/skills.md#Stealth) +6
...
***Bite.*** *Melee Weapon Attack:* +12 to hit, reach 5 ft., one target. *Hit:* 23 (3d10 + 7) piercing damage, and the target is swallowed if it is a Medium or smaller creature. A swallowed creature has the [blinded](rules/conditions.md#Blinded) and [restrained](rules/conditions.md#Restrained) conditions, has total cover against attacks and other effects outside the froghemoth, and takes 10 (3d6) acid damage at the start of each of the froghemoth's turns.

The froghemoth's gullet can hold up to three creatures at a time. If the froghemoth takes 25 damage or more on a single turn from a creature inside it, the froghemoth must succeed on a DC 20 Constitution saving throw at the end of that turn or regurgitate all swallowed creatures, each of which lands in a space within 10 feet of the froghemoth and has the [prone](rules/conditions.md#Prone) condition. If the froghemoth dies, any swallowed creatures are no longer [restrained](rules/conditions.md#Restrained) by it and can escape from the corpse using 10 feet of movement, exiting with the [prone](rules/conditions.md#Prone) condition.

***Tentacle.*** *Melee Weapon Attack:* +12 to hit, reach 20 ft., one target. *Hit:* 20 (3d8 + 7) bludgeoning damage, and the target has the [grappled](rules/conditions.md#Grappled) condition (escape DC 20). Until this grapple ends, the froghemoth can't use this tentacle on another target. The froghemoth has four tentacles.
...
***Leap.*** Immediately after a creature the froghemoth can see ends its turn, the froghemoth jumps up to half its speed. Each creature within 5 feet of the froghemoth when it lands must succeed on a DC 20 Strength saving throw or have the [prone](rules/conditions.md#Prone) condition.

![Froghemoth Elder](compendium/bestiary/legendary-group/froghemoth-elder-qftis.md)
```
