...
aliases:
  - Monstrous Peryton
created: 2026-01-27T15:31:09.114+11:00
...
_Source: Ghosts of Saltmarsh p. 245_
...
```ad-statblock
title: Monstrous Peryton
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/GoS/Monstrous%20Peryton.webp#token)
...
- **Proficiency Bonus** +4
- **Saving Throws** Strength +8, Dexterity +6, Wisdom +6
...
Legendary Action Uses: 3. Immediately after another creature's turn, the monstrous peryton can expend a use to take one of the following actions. The monstrous peryton regains all expended uses at the start of each of its turns.

***Detect.*** The peryton makes a Wisdom ([Perception](rules/skills.md#Perception)) check.
