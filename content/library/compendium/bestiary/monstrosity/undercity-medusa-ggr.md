...
_Source: Guildmasters' Guide to Ravnica p. 222_
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Deception](rules/skills.md#Deception) +5, [Insight](rules/skills.md#Insight) +4, [Perception](rules/skills.md#Perception) +4, [Stealth](rules/skills.md#Stealth) +7
...
***Surprise Attack.*** During the first round of combat, the medusa has advantage on attack rolls against any creature that is [surprised](rules/conditions.md#Surprised), and it deals an extra 10 (3d6) damage each time it hits such a creature with an attack.
