...
_Source: Waterdeep: Dungeon of the Mad Mage p. 158_
...
***Lesser Magic.*** The behir casts [color spray](compendium/spells/color-spray.md) or [sleep](compendium/spells/sleep.md), requiring no components. Its spellcasting ability is Charisma (spell save DC 13).


***Greater Magic (Costs 2 Actions).*** The behir casts [invisibility](compendium/spells/invisibility.md) or [misty step](compendium/spells/misty-step.md), requiring no components.
