...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Acrobatics](rules/skills.md#Acrobatics) +5, [Perception](rules/skills.md#Perception) +5, [Survival](rules/skills.md#Survival) +3
- **Senses** [darkvision](rules/senses.md#Darkvision) 60 ft., passive Perception 15
- **Gear** [lance](compendium/items/lance.md)
...
***Bite (Fox or Hybrid Form Only).*** *Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 8 (1d10 + 3) piercing damage. If the werefox moved at least 20 feet straight toward the target immediately before the hit and the target is a Medium or smaller creature, the target must succeed on a DC 13 Strength saving throw or have the [prone](rules/conditions.md#Prone) condition.

***Lance (Elf or Hybrid Form Only).*** *Melee Weapon Attack:* +5 to hit, reach 10 ft., one target. *Hit:* 9 (1d12 + 3) piercing damage.

***Entangling Arrow (Elf or Hybrid Form Only).*** *Ranged Weapon Attack:* +5 to hit, range 150/600 ft., one target. *Hit:* 10 (2d6 + 3) piercing damage, and the target must succeed on a DC 11 Dexterity saving throw or have the [restrained](rules/conditions.md#Restrained) condition until the start of the werefox's next turn.
...
***Vulpine Nimbleness (Fox or Hybrid Form Only).*** The werefox takes the [Dash](rules/actions.md#Dash) or [Disengage](rules/actions.md#Disengage) action.
```
