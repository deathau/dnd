...
```ad-statblock
title: Leucrotta
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Leucrotta.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Deception](rules/skills.md#Deception) +2, [Perception](rules/skills.md#Perception) +5
