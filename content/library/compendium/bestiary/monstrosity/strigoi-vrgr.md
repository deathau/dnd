...
aliases:
  - Strigoi
created: 2026-01-27T15:31:09.115+11:00
modified: 2026-01-27T16:12:05.190+11:00
tags:
...
_Source: Van Richten's Guide to Ravenloft p. 246_
...
```ad-statblock
title: Strigoi
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VRGR/Strigoi.webp#token)
...
- **Skills** [Perception](rules/skills.md#Perception) +5, [Stealth](rules/skills.md#Stealth) +6
...
***Stirge Telepathy.*** The strigoi can magically command any [stirge](compendium/bestiary/beast/stirge.md) within 120 feet of it, using a limited form of telepathy.
...
***Ravenous Children (1/Day).*** The strigoi magically summons 1d4 + 2 [stirges](compendium/bestiary/beast/stirge.md) (see their entry in the Monster Manual) in unoccupied spaces it can see within 30 feet of it. The stirges are under the strigoi's control and act immediately after the strigoi in the initiative order. The stirges disappear after 1 hour, when the strigoi dies, or when the strigoi dismisses them (no action required).
```
