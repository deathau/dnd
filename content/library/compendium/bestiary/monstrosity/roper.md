...
aliases:
  - Roper
created: 2026-01-27T15:31:09.097+11:00
...
_Source: Monster Manual p. 261, Hoard of the Dragon Queen, Princes of the Apocalypse, Storm King's Thunder, Tales from the Yawning Portal, Waterdeep: Dungeon of the Mad Mage, Critical Role: Call of the Netherdeep, Journeys through the Radiant Citadel, Phandelver and Below: The Shattered Obelisk, The Book of Many Things, Quests from the Infinite Staircase, Out of the Abyss. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>_
...
```ad-statblock
title: Roper
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Roper.webp#token)
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Perception](rules/skills.md#Perception) +6, [Stealth](rules/skills.md#Stealth) +5
