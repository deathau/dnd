...
_Source: Monster Manual p. 155, The Rise of Tiamat, Storm King's Thunder, Tales from the Yawning Portal, Tomb of Annihilation, Icewind Dale: Rime of the Frostmaiden. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)_
...
```ad-statblock
title: Frost Giant
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Frost%20Giant.webp#token)
...
- **Skills** [Athletics](rules/skills.md#Athletics) +9, [Perception](rules/skills.md#Perception) +3
