...
aliases:
  - Huge Gray Ooze
created: 2026-01-27T15:31:07.780+11:00
modified: 2026-01-27T16:12:04.644+11:00
tags:
...
_Source: Waterdeep: Dungeon of the Mad Mage p. 243_

```ad-statblock
title: Huge Gray Ooze
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/WDMM/Huge%20Gray%20Ooze.webp#token)
*Huge ooze, Unaligned*
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Stealth](rules/skills.md#Stealth) +2
...
***Invisibility (Recharges after a Short or Long Rest).*** The ooze magically turns [invisible](rules/conditions.md#Invisible) for up to 1 hour until it attacks, it uses its Enlarge, or its [concentration](rules/conditions.md#Concentration) is broken (as if [concentrating](rules/conditions.md#Concentration) on a spell).
```
