...
_Source: Mythic Odysseys of Theros p. 244_
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Nature](rules/skills.md#Nature) +4, [Perception](rules/skills.md#Perception) +4, [Stealth](rules/skills.md#Stealth) +5
...
***Nimble Escape.*** The triton can take the [Disengage](rules/actions.md#Disengage) or [Hide](rules/actions.md#Hide) actions as a bonus action on each of its turns.
