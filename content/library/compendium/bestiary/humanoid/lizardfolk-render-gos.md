...
aliases:
  - Lizardfolk Render
created: 2026-01-27T15:31:08.839+11:00
modified: 2026-01-27T16:05:47.169+11:00
tags:
...
_Source: Ghosts of Saltmarsh p. 241, Storm Lord's Wrath, Infernal Machine Rebuild_
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Athletics](rules/skills.md#Athletics) +5, [Perception](rules/skills.md#Perception) +3, [Survival](rules/skills.md#Survival) +5
...
***Rend the Field (Recharge 5-6).*** The render makes a claw attack against each creature of its choice within 10 feet of it. A creature hit by this attack must succeed on a DC 13 Strength saving throw or be knocked [prone](rules/conditions.md#Prone).
```
