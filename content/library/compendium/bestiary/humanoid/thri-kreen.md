...
aliases:
  - Thri-kreen
created: 2026-01-27T15:31:08.442+11:00
...
_Source: Monster Manual p. 288, Journeys through the Radiant Citadel, Quests from the Infinite Staircase_
...
```ad-statblock
title: Thri-kreen
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Thri-kreen.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](rules/skills.md#Perception) +3, [Stealth](rules/skills.md#Stealth) +4, [Survival](rules/skills.md#Survival) +3
...
***Chameleon Carapace.*** The thri-kreen can change the color of its carapace to match the color and texture of its surroundings. As a result, it has advantage on Dexterity ([Stealth](rules/skills.md#Stealth)) checks made to hide.
