...
aliases:
  - Grimlock
created: 2026-01-27T15:31:09.059+11:00
modified: 2026-01-27T16:12:05.166+11:00
tags:
...
_Source: Monster Manual p. 175, Waterdeep: Dungeon of the Mad Mage, Phandelver and Below: The Shattered Obelisk, Vecna: Eve of Ruin, Out of the Abyss. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>_
...
```ad-statblock
title: Grimlock
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Grimlock.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Athletics](rules/skills.md#Athletics) +5, [Perception](rules/skills.md#Perception) +3, [Stealth](rules/skills.md#Stealth) +3
- **Senses** [blindsight](rules/senses.md#Blindsight) 30 ft. or 10 ft. while deafened (blind beyond this radius), passive Perception 13
- **Condition Immunities** [blinded](rules/conditions.md#Blinded)
...
***Stone Camouflage.*** The grimlock has advantage on Dexterity ([Stealth](rules/skills.md#Stealth)) checks made to hide in rocky terrain.
