...
aliases:
  - Xvart Speaker
created: 2026-01-27T15:31:08.775+11:00
modified: 2026-01-27T16:12:04.982+11:00
tags:
...
```ad-statblock
title: Xvart Speaker
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VGM/Xvart%20Speaker.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Stealth](rules/skills.md#Stealth) +4
...
***Low Cunning.*** The xvart can take the [Disengage](rules/actions.md#Disengage) action as a bonus action on each of its turns.

***Overbearing Pack.*** The xvart has advantage on Strength ([Athletics](rules/skills.md#Athletics)) checks to shove a creature if at least one of the xvart's allies is within 5 feet of the target and the ally isn't [incapacitated](rules/conditions.md#Incapacitated).
