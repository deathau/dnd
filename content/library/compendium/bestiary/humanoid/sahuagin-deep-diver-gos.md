...
aliases:
  - Sahuagin Deep Diver
created: 2026-01-27T15:31:08.554+11:00
modified: 2026-01-27T16:12:04.844+11:00
tags:
...
_Source: Ghosts of Saltmarsh p. 250, Locathah Rising_
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/GoS/Sahuagin%20Deep%20Diver.webp#token)
...
- **Skills** [Perception](rules/skills.md#Perception) +5, [Stealth](rules/skills.md#Stealth) +5
- **Senses** [darkvision](rules/senses.md#Darkvision) 120 ft., passive Perception 15
- **Gear** [glaive](compendium/items/glaive.md)
- **Languages** Sahuagin
- **Challenge** 4
...
***Brine Lurker.*** The deep diver has advantage on Dexterity ([Stealth](rules/skills.md#Stealth)) checks made while submerged in water.
...
***Light of Sekolah.*** The deep diver pulses magical light from its lure. Any creature within 30 feet of the deep diver that can see the light must succeed on a DC 11 Wisdom saving throw or be [charmed](rules/conditions.md#Charmed) until the end of its next turn. A creature [charmed](rules/conditions.md#Charmed) in this way is [incapacitated](rules/conditions.md#Incapacitated) as it stares at the light.
```
