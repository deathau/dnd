...
modified: 2026-01-27T16:05:46.899+11:00
tags:
...
_Source: Ghosts of Saltmarsh p. 243_
...
- **Skills** [Athletics](rules/skills.md#Athletics) +3, [Perception](rules/skills.md#Perception) +4
...
***Envenomed Crossbow.*** *Ranged Weapon Attack:* +4 to hit, range 80/320 ft., one target. *Hit:* 11 (2d8 + 2) piercing damage, and the target must succeed on a DC 12 Constitution saving throw or be [poisoned](rules/conditions.md#Poisoned) until the end of its next turn.
