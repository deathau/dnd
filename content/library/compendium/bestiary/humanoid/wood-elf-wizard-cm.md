...
_Source: Candlekeep Mysteries p. 187_

```ad-statblock
title: Wood Elf Wizard
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/CM/Wood%20Elf%20Wizard.webp#token)
...
***Spellcasting.*** The wood elf is a 10th-level spellcaster. Its spellcasting ability is Intelligence (spell save DC 14, +6 to hit with spell attacks). The wood elf has the following wizard spells prepared:
...
***Fey Ancestry.*** The wood elf has advantage on saving throws against being [charmed](rules/conditions.md#Charmed), and magic can't put the wood elf to sleep.
