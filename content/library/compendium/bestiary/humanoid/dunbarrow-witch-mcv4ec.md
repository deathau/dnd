...
aliases:
  - Dunbarrow Witch
created: 2026-01-27T15:31:08.692+11:00
modified: 2026-01-27T16:12:04.940+11:00
tags:
...
- **Skills** [Arcana](rules/skills.md#Arcana) +6, [Nature](rules/skills.md#Nature) +6
...
***Polymorph Concoction (1/Day).*** The witch hurls a bottle of liquid at a point up to 20 feet away from itself, which shatters into a cloud of magical smoke that fills a 10-foot-radius sphere. Each creature in that area must succeed on a DC 16 Wisdom saving throw or transform into a creature, as if under the effects of a [polymorph](compendium/spells/polymorph.md) spell, transforming into one of the following forms (roll a d4): 1, bat; 2, frog; 3, lizard; or 4, rat. This transformation lasts for 1 hour or until the creature drops to 0 hit points in its new form.
...
**At will:** [mage armor](compendium/spells/mage-armor.md) (self only), [prestidigitation](compendium/spells/prestidigitation.md)

**2/day each:** [animal messenger](compendium/spells/animal-messenger.md), [charm person](compendium/spells/charm-person.md), [Tasha's hideous laughter](compendium/spells/tashas-hideous-laughter.md)

**1/day each:** [bestow curse](compendium/spells/bestow-curse.md), [dispel magic](compendium/spells/dispel-magic.md)
```
