...
aliases:
  - Githyanki Knight
created: 2026-01-27T15:31:08.876+11:00
...
_Source: Monster Manual p. 160, Waterdeep: Dungeon of the Mad Mage, Phandelver and Below: The Shattered Obelisk, The Book of Many Things, Vecna: Eve of Ruin, Quests from the Infinite Staircase_
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Githyanki%20Knight.webp#token)
...
***Silver Greatsword.*** *Melee Weapon Attack:* +9 to hit, reach 5 ft., one target. *Hit:* 13 (2d6 + 6) slashing damage plus 10 (3d6) psychic damage. This is a magic weapon attack. On a critical hit against a target in an astral body (as with the [astral projection](compendium/spells/astral-projection.md) spell), the githyanki can cut the silvery cord that tethers the target to its material body, instead of dealing damage.
```
