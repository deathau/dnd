...
_Source: Mordenkainen's Fiendish Folio p. 7_
...
```ad-statblock
title: Dire Corby
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MFF/Dire%20Corby.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Acrobatics](rules/skills.md#Acrobatics) +4, [Perception](rules/skills.md#Perception) +3
...
***Dire Cacophony.*** Any creature other than a dire corby that starts its turn within 60 feet of a dire corby and can hear it must make a DC 11 Wisdom saving throw. On a failed save, the creature is unable to use the [Dash](rules/actions.md#Dash) action, cannot climb, or cast spells other than cantrips until the start of its next turn.

***Keen Hearing.*** The dire corby has advantage on Wisdom ([Perception](rules/skills.md#Perception)) checks that rely on hearing.
