...
aliases:
  - Harengon Sniper
created: 2026-01-27T15:31:08.562+11:00
modified: 2026-01-27T16:05:46.861+11:00
tags:
...
_Source: The Wild Beyond the Witchlight p. 235_
...
- **Skills** [Athletics](rules/skills.md#Athletics) +2, [Perception](rules/skills.md#Perception) +5, [Stealth](rules/skills.md#Stealth) +5
- **Senses** passive Perception 15
- **Gear** [club](compendium/items/club.md), [light crossbow](compendium/items/light-crossbow.md)
...
***Light Crossbow.*** *Ranged Weapon Attack:* +5 to hit (the target gains no benefit from less than total cover), range 320 ft., one target. *Hit:* 7 (1d8 + 3) piercing damage. *Hit or Miss:* Immediately after making this attack, the harengon can use the [Hide](rules/actions.md#Hide) action.
```
