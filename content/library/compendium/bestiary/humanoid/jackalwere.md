...
_Source: Monster Manual p. 193, Princes of the Apocalypse, Ghosts of Saltmarsh, Baldur's Gate: Descent Into Avernus, Candlekeep Mysteries, Journeys through the Radiant Citadel, Quests from the Infinite Staircase_
...
```ad-statblock
title: Jackalwere
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Jackalwere.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Deception](rules/skills.md#Deception) +4, [Perception](rules/skills.md#Perception) +2, [Stealth](rules/skills.md#Stealth) +4
