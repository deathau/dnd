...
created: 2026-01-27T15:31:08.614+11:00
modified: 2026-01-27T16:12:04.887+11:00
tags:
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/VGM/Orc%20Red%20Fang%20of%20Shargaas.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Intimidation](rules/skills.md#Intimidation) +1, [Perception](rules/skills.md#Perception) +2, [Stealth](rules/skills.md#Stealth) +5
- **Senses** [darkvision](rules/senses.md#Darkvision) 60 ft., passive Perception 12
- **Gear** [dart](compendium/items/dart.md), [scimitar](compendium/items/scimitar.md)
- **Languages** Common, Orc
- **Challenge** 3

## Traits

***Cunning Action.*** On each of its turns, the orc can use a bonus action to take the [Dash](rules/actions.md#Dash), [Disengage](rules/actions.md#Disengage), or [Hide](rules/actions.md#Hide) action.
...
***Slayer.*** In the first round of a combat, the orc has advantage on attack rolls against any creature that hasn't taken a turn yet. If the orc hits a creature that round who was [surprised](rules/conditions.md#Surprised), the hit is automatically a critical hit.
