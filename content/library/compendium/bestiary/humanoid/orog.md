...
aliases:
  - Orog
created: 2026-01-27T15:31:08.656+11:00
...
_Source: Monster Manual p. 247, Princes of the Apocalypse, Storm King's Thunder, Tales from the Yawning Portal, Waterdeep: Dragon Heist, Waterdeep: Dungeon of the Mad Mage, Ghosts of Saltmarsh, Out of the Abyss_
...
```ad-statblock
title: Orog
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Orog.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Intimidation](rules/skills.md#Intimidation) +5, [Survival](rules/skills.md#Survival) +2
