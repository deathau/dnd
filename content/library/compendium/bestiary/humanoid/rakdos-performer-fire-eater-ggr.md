...
_Source: Guildmasters' Guide to Ravnica p. 249_
...
- **Skills** [Acrobatics](rules/skills.md#Acrobatics) +7, [Performance](rules/skills.md#Performance) +4
...
***Nimble.*** The performer can take the [Disengage](rules/actions.md#Disengage) action as a bonus action on each of its turns.
