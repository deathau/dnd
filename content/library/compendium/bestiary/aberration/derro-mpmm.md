...
_Source: Mordenkainen Presents: Monsters of the Multiverse p. 91, Mordenkainen's Tome of Foes p. 158, Quests from the Infinite Staircase_
...
```ad-statblock
title: Derro
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Derro.webp#token)
...
- **Gear** [light crossbow](compendium/items/light-crossbow.md)
