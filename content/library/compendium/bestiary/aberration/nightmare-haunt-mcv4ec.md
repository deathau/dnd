...
aliases:
  - Nightmare Haunt
created: 2026-01-27T15:31:08.933+11:00
modified: 2026-01-27T16:12:05.086+11:00
tags:
...
_Source: Monstrous Compendium Volume 4: Eldraine Creatures_
...
- **Saving Throws** ⏤
- **Skills** ⏤
- **Senses** [blindsight](rules/senses.md#Blindsight) 120 ft. (can't see beyond this radius), passive Perception 11
- **Damage Immunities** psychic
- **Condition Immunities** [blinded](rules/conditions.md#Blinded), [charmed](rules/conditions.md#Charmed), [exhaustion](rules/conditions.md#Exhaustion), [frightened](rules/conditions.md#Frightened)
...
***Somnophage.*** At the start of its turn, the nightmare haunt gains a number of temporary hit points equal to 5 times the number of [unconscious](rules/conditions.md#Unconscious) creatures within 30 feet of itself.
...
***Tendrils of Slumber (Recharge 5-6).*** The nightmare haunt creates spectral tendrils that cover the ground in a 20-foot square that it can see within 30 feet of itself for 1 minute or until it uses this action again. When a creature other than the nightmare haunt enters the affected area for the first time or starts its turn there, the creature must succeed on a DC 14 Strength saving throw or take 11 (2d10) necrotic damage and have the [restrained](rules/conditions.md#Restrained) condition. The affected ground is also considered difficult terrain for creatures other than the nightmare haunt for the duration of its effect.

A creature that starts its turn in the area and is already [restrained](rules/conditions.md#Restrained) by the tendrils must repeat the saving throw. On a failed save, it has the [unconscious](rules/conditions.md#Unconscious) condition and instead of the [restrained](rules/conditions.md#Restrained) condition caused by the tendrils. On a successful save, the effect ends on the creature. An [unconscious](rules/conditions.md#Unconscious) creature remains asleep until it is no longer in the area with tendrils, takes any damage, or is targeted by a [remove curse](compendium/spells/remove-curse.md) spell or similar magic.

## Bonus Actions

***Shadow Stealth.*** While in dim light or darkness, the nightmare haunt takes the [Hide](rules/actions.md#Hide) action.
```
