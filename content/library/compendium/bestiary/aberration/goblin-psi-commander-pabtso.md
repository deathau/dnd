...
created: 2026-01-27T15:31:08.891+11:00
modified: 2026-01-27T16:12:05.056+11:00
tags:
...
_Source: Phandelver and Below: The Shattered Obelisk p. 216_
...
- **Skills** [Stealth](rules/skills.md#Stealth) +8
...
***Mental Fortitude.*** The goblin has advantage on saving throws against effects that would make it have the [charmed](rules/conditions.md#Charmed) or [frightened](rules/conditions.md#Frightened) conditions.
...
***Synaptic Rend (Recharge 5-6).*** The goblin unleashes a 30-foot-radius sphere of psychic energy, centered on a point the goblin can see within 60 feet of itself. Each creature in that area must make a DC 13 Intelligence saving throw. On a failed save, a creature takes 14 (4d6) psychic damage and has the [incapacitated](rules/conditions.md#Incapacitated) condition until the end of the goblin's next turn. On a successful save, a creature takes half as much damage only.
...
***Nimble Escape.*** The goblin takes the [Disengage](rules/actions.md#Disengage) or [Hide](rules/actions.md#Hide) action.
