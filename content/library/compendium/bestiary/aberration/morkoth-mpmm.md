...
```ad-statblock
title: Morkoth
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Morkoth.webp#token)
...
- **Skills** [Arcana](rules/skills.md#Arcana) +9, [History](rules/skills.md#History) +9, [Perception](rules/skills.md#Perception) +10, [Stealth](rules/skills.md#Stealth) +6
