...
_Source: Monster Manual p. 135, Waterdeep: Dungeon of the Mad Mage, Phandelver and Below: The Shattered Obelisk, The Book of Many Things, Out of the Abyss_
...
```ad-statblock
title: Flumph
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Flumph.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Arcana](rules/skills.md#Arcana) +4, [History](rules/skills.md#History) +4, [Religion](rules/skills.md#Religion) +4
...
***Advanced Telepathy.*** The flumph can perceive the content of any telepathic communication used within 60 feet of it, and it can't be [surprised](rules/conditions.md#Surprised) by creatures with any form of telepathy.
