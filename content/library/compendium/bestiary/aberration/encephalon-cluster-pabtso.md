...
_Source: Phandelver and Below: The Shattered Obelisk p. 205_
...
- **Saving Throws** ⏤
- **Skills** ⏤
- **Senses** [blindsight](rules/senses.md#Blindsight) 60 ft. (can't see beyond this radius), passive Perception 13
...
***Slam.*** *Melee Weapon Attack:* +10 to hit, reach 5 ft., one target. *Hit:* 17 (2d10 + 6) bludgeoning damage plus 10 (3d6) psychic damage, and if the target is a creature, the target must succeed on a DC 18 Strength saving throw or have the [prone](rules/conditions.md#Prone) condition. If this attack reduces the target to 0 hit points, the target immediately dies and is consumed by the cluster.
