...
aliases:
  - Gibbering Mouther
created: 2026-01-27T15:31:09.170+11:00
...
_Source: Monster Manual p. 157, Tales from the Yawning Portal, Waterdeep: Dragon Heist, Waterdeep: Dungeon of the Mad Mage, Eberron: Rising from the Last War, Icewind Dale: Rime of the Frostmaiden, Tasha's Cauldron of Everything, Critical Role: Call of the Netherdeep, Journeys through the Radiant Citadel, Keys from the Golden Vault, Phandelver and Below: The Shattered Obelisk, The Book of Many Things, Quests from the Infinite Staircase, Out of the Abyss, Lost Laboratory of Kwalish. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>_
...
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Gibbering%20Mouther.webp#token)
...
***Bites.*** *Melee Weapon Attack:* +2 to hit, reach 5 ft., one creature. *Hit:* 17 (5d6) piercing damage. If the target is Medium or smaller, it must succeed on a DC 10 Strength saving throw or be knocked [prone](rules/conditions.md#Prone). If the target is killed by this damage, it is absorbed into the mouther.
