...
```ad-statblock
title: Reduced-Threat Aboleth
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/TftYP/Reduced-Threat%20Aboleth.webp#token)
...
- **Proficiency Bonus** +4
- **Saving Throws** Constitution +4, Intelligence +6, Wisdom +4
- **Skills** [History](rules/skills.md#History) +10, [Perception](rules/skills.md#Perception) +8
...
Legendary Action Uses: 3. Immediately after another creature's turn, the reduced-threat aboleth can expend a use to take one of the following actions. The reduced-threat aboleth regains all expended uses at the start of each of its turns.
