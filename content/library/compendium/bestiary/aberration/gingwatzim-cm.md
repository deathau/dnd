...
_Source: Candlekeep Mysteries p. 27_
...
***Energy Drain (True Form Only).*** *Melee Weapon Attack:* +4 to hit, reach 5 ft., one creature. *Hit:* 16 (4d6 + 2) necrotic damage, and the target must succeed on a DC 12 Constitution saving throw or gain 1 level of [exhaustion](rules/conditions.md#Exhaustion). When the target finishes a short or long rest, the target loses every level of [exhaustion](rules/conditions.md#Exhaustion) gained from this attack.
