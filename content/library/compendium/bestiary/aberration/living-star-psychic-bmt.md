...
aliases:
  - Living Star (Psychic)
created: 2026-01-27T15:31:07.751+11:00
modified: 2026-01-27T16:12:04.585+11:00
tags:
...
_Source: The Book of Many Things p. 180_

```ad-statblock
title: Living Star (Psychic)
...
- **Skills** [Arcana](rules/skills.md#Arcana) +6, [History](rules/skills.md#History) +6, [Insight](rules/skills.md#Insight) +5, [Perception](rules/skills.md#Perception) +5
- **Senses** [darkvision](rules/senses.md#Darkvision) 120 ft., passive Perception 15
- **Damage Immunities** radiant
- **Condition Immunities** [exhaustion](rules/conditions.md#Exhaustion)
- **Languages** all
- **Challenge** 3
...
***Radiant Strike.*** *Melee  or Ranged Spell Attack:* +5 to hit, reach 5 ft. or range 120 ft., one target. *Hit:* 9 (1d12 + 3) psychic damage.
...
**1/day each:** [Divination](compendium/spells/divination.md), [Greater Restoration](compendium/spells/greater-restoration.md)
...
***Price of Defiance.*** When the living portent is damaged by a creature that it can see within 120 feet of itself, psychic power sears the creature. The creature must make a DC 13 Constitution saving throw, taking 10 (3d6) psychic damage on a failed save, or half as much damage on a successful one.
```
