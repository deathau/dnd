...
_Source: Mythic Odysseys of Theros p. 242_
...
```ad-statblock
title: Satyr Reveler
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MOT/Satyr%20Reveler.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Acrobatics](rules/skills.md#Acrobatics) +5, [Performance](rules/skills.md#Performance) +7, [Stealth](rules/skills.md#Stealth) +5
