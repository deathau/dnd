...
```ad-statblock
title: Korred
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Korred.webp#token)
...
- **Proficiency Bonus** +3
- **Saving Throws** ⏤
- **Skills** [Athletics](rules/skills.md#Athletics) +9, [Perception](rules/skills.md#Perception) +5, [Stealth](rules/skills.md#Stealth) +5
- **Senses** [darkvision](rules/senses.md#Darkvision) 120 ft., tremorsense 120 ft., passive Perception 15
