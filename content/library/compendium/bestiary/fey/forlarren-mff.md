...
aliases:
  - Forlarren
created: 2026-01-27T15:31:08.646+11:00
modified: 2026-01-27T16:12:04.905+11:00
tags:
...
_Source: Mordenkainen's Fiendish Folio p. 9_
...
A forlarren in its fey aspect demonstrates self-destructive urges that reflect the inherent tension in its nature. That aspect might drive it to drink itself nearly to death, or to throw itself into caring for others with such relentless energy that it eventually collapses from [exhaustion](rules/conditions.md#Exhaustion). Unfortunately, when it reaches that breaking point, its diabolical nature asserts itself, and it remains in this scheming, dominating mindset until its plans are foiled and it faces defeat. Then, overwhelmed with fear and shame, the forlarren's diabolical nature fades and its fey aspect emerges once again.
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Acrobatics](rules/skills.md#Acrobatics) +5, [Deception](rules/skills.md#Deception) +8, [Stealth](rules/skills.md#Stealth) +5
