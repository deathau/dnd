...
```ad-statblock
title: Quickling
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Quickling.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Acrobatics](rules/skills.md#Acrobatics) +8, [Sleight of Hand](rules/skills.md#Sleight%20of%20Hand) +8, [Stealth](rules/skills.md#Stealth) +8, [Perception](rules/skills.md#Perception) +5
