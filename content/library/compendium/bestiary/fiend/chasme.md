...
_Source: Monster Manual p. 57, Waterdeep: Dungeon of the Mad Mage, Baldur's Gate: Descent Into Avernus, Critical Role: Call of the Netherdeep, Keys from the Golden Vault, Quests from the Infinite Staircase, Out of the Abyss_
...
```ad-statblock
title: Chasme
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Chasme.webp#token)
