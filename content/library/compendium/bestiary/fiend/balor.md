...
_Source: Monster Manual p. 55, Baldur's Gate: Descent Into Avernus, Infernal Machine Rebuild, Tasha's Cauldron of Everything, Critical Role: Call of the Netherdeep, Out of the Abyss. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>_
...
```ad-statblock
title: Balor
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MM/Balor.webp#token)
