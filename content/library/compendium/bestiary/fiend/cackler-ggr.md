...
_Source: Guildmasters' Guide to Ravnica p. 195_
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Deception](rules/skills.md#Deception) +3, [Perception](rules/skills.md#Perception) +0, [Performance](rules/skills.md#Performance) +3
...
***Mimicry.*** The cackler can mimic any sounds it has heard, including voices. A creature that hears the sounds can tell they are imitations with a successful DC 11 Wisdom ([Insight](rules/skills.md#Insight)) check.
