...
aliases:
  - Kakkuu Spyder-Fiend
created: 2026-01-27T15:31:08.723+11:00
modified: 2026-01-27T16:12:04.957+11:00
tags:
...
_Source: Vecna: Eve of Ruin p. 234_
...
***Reel.*** The kakkuu pulls each creature within 60 feet of itself that is [grappled](rules/conditions.md#Grappled) by its Web Snare up to 30 feet straight toward itself.

***Web Snare.*** *Ranged Weapon Attack:* +6 to hit, reach 30/60 ft., one Large or smaller creature. *Hit:* The target has the [grappled](rules/conditions.md#Grappled) condition (escape DC 13). While [grappled](rules/conditions.md#Grappled), the target also has the [restrained](rules/conditions.md#Restrained) condition. A web snare grappling a creature can be attacked and destroyed (AC 10; 10 hit points; immunity to bludgeoning, poison, and psychic damage).
```
