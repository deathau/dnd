...
aliases:
  - Blade Lieutenant
created: 2026-01-27T15:31:07.803+11:00
modified: 2026-01-27T16:12:04.655+11:00
tags:
...
_Source: Vecna: Eve of Ruin p. 209_
...
- **Skills** [Insight](rules/skills.md#Insight) +6, [Intimidation](rules/skills.md#Intimidation) +7, [Perception](rules/skills.md#Perception) +6
...
***Pack Tactics.*** The lieutenant has advantage on an attack roll against a creature if at least one of the lieutenant's allies is within 5 feet of the creature and the ally doesn't have the [incapacitated](rules/conditions.md#Incapacitated) condition.
...
***Javelin Launcher.*** *Ranged Weapon Attack:* +8 to hit, range 30/120 ft., one target. *Hit:* 14 (3d6 + 4) piercing damage, and the target has the [prone](rules/conditions.md#Prone) condition.
...
***Rally the Troops (1/Day).*** The lieutenant ends the [charmed](rules/conditions.md#Charmed) and [frightened](rules/conditions.md#Frightened) conditions on itself and each creature of its choice that it can see within 30 feet of itself.
