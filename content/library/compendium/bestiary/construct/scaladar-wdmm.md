...
modified: 2026-01-27T16:05:45.884+11:00
tags:
...
_Source: Waterdeep: Dungeon of the Mad Mage p. 315_
...
***Claw.*** *Melee Weapon Attack:* +7 to hit, reach 10 ft., one target. *Hit:* 10 (1d12 + 4) bludgeoning damage, and the target is [grappled](rules/conditions.md#Grappled) (escape DC 15). The scaladar has two claws, each of which can grapple one target.
