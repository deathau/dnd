...
aliases:
  - Vegepygmy Scavenger
created: 2026-01-27T15:31:07.830+11:00
...
_Source: Quests from the Infinite Staircase p. 218_
...
```ad-statblock
title: Vegepygmy Scavenger
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/QftIS/Vegepygmy%20Scavenger.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](rules/skills.md#Perception) +2, [Sleight of Hand](rules/skills.md#Sleight%20of%20Hand) +4, [Stealth](rules/skills.md#Stealth) +4
- **Senses** [darkvision](rules/senses.md#Darkvision) 60 ft., passive Perception 12
- **Damage Resistances** lightning, piercing
- **Gear** [sling](compendium/items/sling.md)
- **Languages** Vegepygmy
- **Challenge** 1/4
...
***Nimble Escape.*** The vegepygmy takes the [Disengage](rules/actions.md#Disengage) or [Hide](rules/actions.md#Hide) action.
```
