...
modified: 2026-01-27T16:12:04.593+11:00
tags:
...
_Source: Quests from the Infinite Staircase p. 219_
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](rules/skills.md#Perception) +4, [Stealth](rules/skills.md#Stealth) +4, [Survival](rules/skills.md#Survival) +4
...
***Pack Tactics.*** The vegepygmy has advantage on attack rolls against a creature if at least one of the vegepygmy's allies is within 5 feet of the creature and the ally doesn't have the [incapacitated](rules/conditions.md#Incapacitated) condition.
...
***Bite.*** *Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 11 (2d8 + 2) piercing damage. If the target is a creature, it must succeed on a DC 12 Strength saving throw or have the [prone](rules/conditions.md#Prone) condition.
```
