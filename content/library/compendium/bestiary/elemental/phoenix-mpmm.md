...
_Source: Mordenkainen Presents: Monsters of the Multiverse p. 206, Mordenkainen's Tome of Foes p. 199_
...
```ad-statblock
title: Phoenix
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Phoenix.webp#token)
...
***Flyby.*** The phoenix doesn't provoke [opportunity attacks](rules/actions.md#Opportunity%20Attack) when it flies out of an enemy's reach.
...
Legendary Action Uses: 3. Immediately after another creature's turn, the phoenix can expend a use to take one of the following actions. The phoenix regains all expended uses at the start of each of its turns.
