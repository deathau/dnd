...
_Source: Mordenkainen Presents: Monsters of the Multiverse p. 278, Mordenkainen's Tome of Foes p. 201_
...
```ad-statblock
title: Zaratan
![](https://raw.githubusercontent.com/5etools-mirror-3/5etools-img/main/bestiary/tokens/MPMM/Zaratan.webp#token)
...
- **Skills** ⏤
- **Senses** [darkvision](rules/senses.md#Darkvision) 60 ft., tremorsense 60 ft., passive Perception 15
- **Damage Resistances** cold; fire; lightning; bludgeoning, piercing, slashing from nonmagical attacks
- **Damage Immunities** poison
- **Condition Immunities** [exhaustion](rules/conditions.md#Exhaustion), [paralyzed](rules/conditions.md#Paralyzed), [petrified](rules/conditions.md#Petrified), [poisoned](rules/conditions.md#Poisoned), [stunned](rules/conditions.md#Stunned)
- **Languages** —
- **Challenge** 22
