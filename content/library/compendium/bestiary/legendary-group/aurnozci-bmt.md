...
- **Boiling Water.** Bodies of water on Xulregg perpetually boil, and even bottled liquids steam when exposed to the layer's atmosphere. Being immersed in water there doesn't confer resistance to fire damage, and a creature that starts its turn in water takes `dice:2d6|noform|noparens|avg|text(7)` (`2d6`) fire damage. A creature that imbibes a liquid (such as a potion) takes `dice:1d6|noform|noparens|avg|text(3)` (`1d6`) fire damage.
...
If Aurnozci dies, these effects fade over the course of `dice:1d10|noform|noparens|avg` (`1d10`) days.
