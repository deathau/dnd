...
aliases:
  - Yan-C-Bin
created: 2026-01-27T14:36:21.194+11:00
...
- Yan-C-Bin drops the temperature of the air, covering all surfaces with ice. This effect is identical to the [sleet storm](compendium/spells/sleet-storm.md) spell.
...
If Yan-C-Bin is destroyed or banished back to his home plane, the regional effects fade over the next `dice:1d10|noform|noparens|avg` (`1d10`) days.
