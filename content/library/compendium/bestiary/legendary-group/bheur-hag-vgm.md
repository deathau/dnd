...
- The hag creates a blizzard in a 40-foot-high, 20-foot radius cylinder centered on a point she can see within 120 feet of her. The effect lasts until initiative count 20 on the next round. The blizzard lightly obscures every creature and object in the area for the duration. A creature that enters the blizzard for the first time on a turn or starts its turn there is [blinded](rules/conditions.md#Blinded) until initiative count 20 on the next round.
...
- Small avalanches of snow intermittently fall, blocking a path or burying intruders. A buried creature is [restrained](rules/conditions.md#Restrained) and has to hold its breath until it is dug out.
