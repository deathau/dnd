...
aliases:
  - White Dragon
created: 2026-01-27T14:36:21.224+11:00
modified: 2026-01-27T15:31:10.166+11:00
tags:
...
- Freezing fog fills a 20-foot-radius sphere centered on a point the dragon can see within 120 feet of it. The fog spreads around corners, and its area is heavily obscured. Each creature in the fog when it appears must make a DC 10 Constitution saving throw, taking `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) cold damage on a failed save, or half as much damage on a successful one. A creature that ends its turn in the fog takes `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) cold damage. A wind of at least 20 miles per hour disperses the fog. The fog otherwise lasts until the dragon uses this lair action again or until the dragon dies.
- Jagged ice shards fall from the ceiling, striking up to three creatures underneath that the dragon can see within 120 feet of it. The dragon makes one ranged attack roll (`dice:1d20+7|noform|noparens|text(+7)` to hit) against each target. On a hit, the target takes `dice:3d6|noform|noparens|avg|text(10)` (`3d6`) piercing damage.
...
Any of these effects might appear in the area around a white dragon's lair, in addition to or instead of the effects described in the _Monster Manual_:
