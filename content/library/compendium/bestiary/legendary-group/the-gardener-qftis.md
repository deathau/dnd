...
- **Gardener's Vigil.** The Gardener senses when anything dies in the garden. If a creature dies in the garden, roll a `dice:d6|noform|noparens|avg` (`d6`). On a 1, the Gardener appears on initiative count 20 of the next round (losing initiative ties) to investigate.
