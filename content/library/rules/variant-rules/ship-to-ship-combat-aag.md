...
aliases:
  - Ship-to-Ship Combat
created: 2026-02-03T15:06:54.278+11:00
modified: 2026-02-03T15:06:54.278+11:00
tags:
...
The "Dungeon Master's Guide" presents a variant rule called [Side Initiative](rules/variant-rules/initiative-variants.md), which is ideal for ship-to-ship engagements, since it saves you the trouble of tracking initiative for individual creatures aboard each ship.
...
A ship that has enough movement can pull alongside another vessel, deploy a boarding party, and then move away, provided the members of the boarding party took the [Ready](rules/actions.md#Ready) action to position themselves so they can move onto the other vessel when it's close enough.
