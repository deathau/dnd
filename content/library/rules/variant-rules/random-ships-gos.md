...
_Source: Ghosts of Saltmarsh p. 208_
...
- The ship can move through other creatures and objects as if they were difficult terrain. It takes `dice:1d10|noform|noparens|avg|text(5)` (`1d10`) force damage if it ends its turn inside an object.
