...
aliases:
  - Planar Effects
created: 2026-01-27T14:36:21.288+11:00
modified: 2026-01-27T15:31:10.252+11:00
tags:
...
If a corrupted creature doesn't leave the plane within `dice:1d4+2|noform|noparens|avg` (`1d4 + 2`) days, its alignment changes to chaotic evil. Casting the [dispel evil and good](compendium/spells/dispel-evil-and-good.md) spell on the creature restores its original alignment.
...
While on Mechanus, creatures always use the average damage result for attacks and spells. For example, an attack that normally deals `dice:1d10+5|noform|noparens|avg` (`1d10 + 5`) damage always deals 10 damage on Mechanus.
