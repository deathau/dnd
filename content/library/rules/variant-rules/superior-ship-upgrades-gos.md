...
_Source: Ghosts of Saltmarsh p. 196_
...
Adding an upgrade costs 15,000 gp and requires `dice:1d4|noform|noparens|avg` (`1d4`) weeks of work. During that time, the ship must remain in port. If the ship leaves, the work must start over, but you don't need to pay the gold piece cost a second time.
