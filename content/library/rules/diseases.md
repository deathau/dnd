...
aliases:
  - Diseases
created: 2026-01-27T14:36:21.289+11:00
modified: 2026-01-27T15:31:10.253+11:00
tags:
...
Any humanoid that spends 12 hours in the necropolis must succeed on a DC 15 Constitution saving throw or contract an arcane blight. This magical disease transforms the humanoid into a [nothic](compendium/bestiary/aberration/nothic.md), but only after the victim experiences hallucinations and feelings of isolation and paranoia. Other symptoms include clammy skin, hair loss, and myopia (nearsightedness).
...
Whenever it finishes a long rest, an infected humanoid must repeat the saving throw. On a successful save, the DC for future saves against the arcane blight drops by `dice:1d6|noform|noparens|avg` (`1d6`). If the saving throw DC drops to 0, the creature overcomes the arcane blight and becomes immune to the effect of further exposure. A creature that fails three of these saving throws transforms into a [nothic](compendium/bestiary/aberration/nothic.md) under the DM's control. Only a [wish](compendium/spells/wish.md) spell or divine intervention can undo this transformation.

A [greater restoration](compendium/spells/greater-restoration.md) spell or similar magic ends the infection on the target, removing the flaw and all other symptoms, but this magic doesn't protect the target against further exposure.
...
A magical mist creeps through the jungles of Chult. Contact with this thin, blue, odorless mist can infect giants and humanoids with blue mist fever. A [dispel magic](compendium/spells/dispel-magic.md) spell destroys the mist in a 20-foot square starting at a point chosen by the caster within the spell's range. An encounter with this mist typically covers `dice:1d6|noform|noparens|avg` (`1d6`) such areas (400-2,400 square feet).
...
Symptoms manifest `dice:1d4|noform|noparens|avg` (`1d4`) hours after infection and include fever and disorientation. The infected creature gains one level of [exhaustion](rules/conditions.md#Exhaustion) that can't be removed until the disease is cured.
...
The constant smog in Gracklstugh causes grackle-lung in living, breathing creatures, resulting in persistent, wracking coughs and the spewing of thick, black phlegm. Whenever a living, breathing creature finishes a long rest in Gracklstugh, it must make a DC 11 Constitution saving throw. On each failed save, the creature gains one level of [exhaustion](rules/conditions.md#Exhaustion) as its airways become increasingly clogged. A creature that reaches level 6 [exhaustion](rules/conditions.md#Exhaustion) dies, as normal.

A creature with one or more levels of [exhaustion](rules/conditions.md#Exhaustion) brought on by grackle-lung must succeed on a Constitution check to take the [Dash](rules/actions.md#Dash) action. If the check fails, the action cannot be attempted. If the creature attempts to cast a spell with a verbal component, it must succeed on a Constitution check or be unable to complete the spell, causing the spell to fail with no effect. The DC for each check is 10 + the creature's current [exhaustion](rules/conditions.md#Exhaustion) level.

If a creature's [exhaustion](rules/conditions.md#Exhaustion) level drops below 1, it no longer suffers the effects of grackle-lung and becomes immune to it for the next week. Duergar and derro are inured to grackle-lung, making Constitution checks against it with advantage. Any spell or effect that cures disease also cures grackle-lung, effectively removing all levels of [exhaustion](rules/conditions.md#Exhaustion) brought on by the affliction.
...
The effects of redface are identical to those of [sight rot](rules/diseases.md#Sight%20Rot) (see ""Diseases"" in chapter 8 of the "Dungeon Master's Guide"), but it's caused by pollutants in the air rather than contaminated drinking water, making it difficult to avoid.
...
After a failed save, a creature experiences the first symptoms—body aches, nausea, slurred speech, and uncontrollable drooling—`dice:1d4|noform|noparens|avg` (`1d4`) hours later and gains 1 level of [exhaustion](rules/conditions.md#Exhaustion). Every 24 hours thereafter, the creature automatically gains another level of [exhaustion](rules/conditions.md#Exhaustion). Any creature killed by the saprophytic plague transforms into a lifeless magenta ooze.
...
Any magic that cures a disease can rid a creature of the saprophytic plague. Casting [purify food and drink](compendium/spells/purify-food-and-drink.md) destroys the infection in foodstuffs.
...
A giant or humanoid that takes damage from [insect swarms](compendium/bestiary/beast/swarm-of-insects.md) or from [giant centipedes](compendium/bestiary/beast/giant-centipede.md), [giant scorpions](compendium/bestiary/beast/giant-scorpion.md), or [giant wasps](compendium/bestiary/beast/giant-wasp.md) is exposed to the disease at the end of the encounter. Those who haven't applied insect repellent since their previous long rest are exposed to the disease when they finish a long rest.
...
**Transmission.** The Gnaws is spread when a creature is bitten by a [rat](compendium/bestiary/beast/rat.md), [giant rat](compendium/bestiary/beast/giant-rat.md), [swarm of rats](compendium/bestiary/beast/swarm-of-rats.md), or [wererat](compendium/bestiary/humanoid/wererat.md) that carries the disease, or by coming into physical contact with an infected creature.
...
**Symptoms.** It takes `dice:1d2|noform|noparens|avg` (`1d2`) days for the Gnawing Plague's symptoms to manifest in an infected creature. The infected creature then gains 1 level of [exhaustion](rules/conditions.md#Exhaustion), regains only half the normal number of hit points from spending Hit Dice, and regains no hit points from finishing a long rest.
...
Minuscule parasites known as throat leeches infect the water in Chult's forests, swamps, and rivers. Any giant or humanoid that swallows tainted water must succeed on a DC 12 Constitution saving throw or be infested with throat leeches. Immediate symptoms include throat inflammation and shortness of breath. After `dice:1d6|noform|noparens|avg` (`1d6`) hours, the infected character gains 1 level of [exhaustion](rules/conditions.md#Exhaustion) that can't be removed (except as described below) until the disease is cured. At the end of each long rest, the infected creature must repeat the saving throw. On a failed save, the creature's [exhaustion](rules/conditions.md#Exhaustion) increases by 1 level; on a successful save, the creature's [exhaustion](rules/conditions.md#Exhaustion) decreases by 1 level. If a successful saving throw reduces the infected creature's level of [exhaustion](rules/conditions.md#Exhaustion) below 1, the creature recovers from the disease.
